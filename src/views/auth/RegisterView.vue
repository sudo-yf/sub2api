  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div class="text-center">
        <h2 class="text-2xl font-bold text-neutral-100 dark:text-white">
      ...
      <div
        ...
        class="rounded-xl border border-neutral-800/60 bg-neutral-900/40 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]"
      >
        <div class="flex items-start gap-3">
          <div class="flex-shrink-0">
            <Icon name="exclamationCircle" size="md" class="text-[#d08770]/80" />
          </div>
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="mail" size="md" class="text-[#bda993]" />
            </div>
            <input
              id="email"
        ...
        <div>
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="lock" size="md" class="text-[#bda993]" />
            </div>
            <input
              id="password"
            ...
            <button
              ...
              class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-[#bda993] transition-colors hover:text-[#f0ddc6]"
            >
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-[#a3be8c]/80' : 'text-[#bda993]'" />
            </div>
            <input
              id="invitation_code"
              ...
              :class="{
                'border-[#a3be8c]/20 focus:border-[#a3be8c]/20 focus:ring-green-500': invitationValidation.valid,
                'border-[#bf616a]/20 focus:border-[#bf616a]/20 focus:ring-red-500': invitationValidation.invalid || errors.invitation_code
              }"
            ...
            <div v-else-if="invitationValidation.valid" class="absolute inset-y-0 right-0 flex items-center pr-3.5">
              <Icon name="checkCircle" size="md" class="text-[#a3be8c]/80" />
            </div>
            <div v-else-if="invitationValidation.invalid || errors.invitation_code" class="absolute inset-y-0 right-0 flex items-center pr-3.5">
              <Icon name="exclamationCircle" size="md" class="text-[#bf616a]/80" />
            </div>
          </div>
          <!-- Invitation code validation result -->
          <transition name="fade">
            <div v-if="invitationValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-[#a3be8c]/12 px-3 py-2 dark:bg-[#a3be8c]/12">
              <Icon name="checkCircle" size="sm" class="text-[#a3be8c]/80 dark:text-[#a3be8c]" />
              <span class="text-sm text-[#a3be8c]/80 dark:text-[#a3be8c]">
        ...
        <div v-if="promoCodeEnabled">
          <label for="promo_code" class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-[#bda993]/70">({{ t('common.optional') }})</span>
          </label>
          <div class="relative">
            <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
              <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-[#a3be8c]/80' : 'text-[#bda993]'" />
            </div>
            <input
              id="promo_code"
              ...
              class="input pl-11 pr-10"
              :class="{
                'border-[#a3be8c]/20 focus:border-[#a3be8c]/20 focus:ring-green-500': promoValidation.valid,
                'border-[#bf616a]/20 focus:border-[#bf616a]/20 focus:ring-red-500': promoValidation.invalid
              }"
          ...
          <transition name="fade">
            <div v-if="promoValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-[#a3be8c]/12 px-3 py-2 dark:bg-[#a3be8c]/12">
              <Icon name="gift" size="sm" class="text-[#a3be8c]/80 dark:text-[#a3be8c]" />
              <span class="text-sm text-[#a3be8c]/80 dark:text-[#a3be8c]">
      ...
      <div v-if="showOAuthLogin" class="space-y-3 pt-1">
        <div class="flex items-center gap-3">
          <div class="h-px flex-1 bg-[linear-gradient(90deg,transparent,rgba(240,221,198,0.2))]"></div>
          <span class="text-xs text-neutral-500 dark:text-neutral-400">
            {{ t('auth.oauthOrContinue') }}
          </span>
          <div class="h-px flex-1 bg-[linear-gradient(90deg,rgba(240,221,198,0.2),transparent)]"></div>
        </div>
    ...
    <template #footer>
      <p class="text-neutral-500 dark:text-neutral-400">
        ...
        <router-link
          to="/login"
          class="font-medium text-neutral-300 transition-colors hover:text-neutral-500 dark:text-neutral-400 dark:hover:text-neutral-300"
        >
          {{ t('auth.signIn') }}
        </router-link>
      </p>
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'CCF'
