      ...
      <transition name="fade">
        ...
        >
          <div
            ...
            class="rounded-xl border border-[rgba(240,221,198,0.12)] bg-[linear-gradient(180deg,rgba(240,221,198,0.08),rgba(255,255,255,0.02))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
          >
            <div class="space-y-3">
              <div class="space-y-1">
              ...
              <label
                ...
                class="flex items-start gap-3 rounded-lg border border-[rgba(240,221,198,0.12)] bg-[rgba(18,23,29,0.72)] p-3 text-sm"
              >
                <input v-model="adoptDisplayName" type="checkbox" class="mt-1 h-4 w-4" />
                <span class="space-y-1">
                  <span class="block font-medium text-neutral-100 dark:text-white">
              ...
              >
                ...
                <img
                  ...
                  class="h-10 w-10 rounded-full border border-gray-200 object-cover dark:border-neutral-800/60"
                />
                <span class="space-y-1">
                  <span class="block font-medium text-neutral-100 dark:text-white">
                    {{ t('auth.oauthFlow.useAvatar') }}
                  </span>
                  <span class="block break-all text-neutral-500 dark:text-neutral-400">
                    {{ suggestedAvatarUrl }}
                  </span>
                </span>
              </label>
          ...
          <template v-else-if="needsChooser">
            <div class="rounded-xl border border-[rgba(240,221,198,0.12)] bg-[linear-gradient(180deg,rgba(240,221,198,0.08),rgba(255,255,255,0.02))] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
              <div class="space-y-4">
                <div class="space-y-1">
                  <p class="text-sm font-medium text-neutral-100 dark:text-white">
