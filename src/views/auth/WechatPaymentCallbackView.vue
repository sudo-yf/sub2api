  ...
  <div class="min-h-screen bg-gray-50 px-4 py-10 dark:bg-[#0d0d0d]">
    <div class="mx-auto max-w-2xl">
      <div class="card p-6">
        ...
        >
          <div
            class="h-8 w-8 animate-spin rounded-full border-4 border-neutral-600/60 border-t-transparent"
          ></div>
        </div>

        <div
          v-else
          class="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-neutral-800/60 dark:bg-neutral-800/80"
        >
