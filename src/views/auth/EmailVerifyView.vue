<template>
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
          {{ t('auth.sendCodeDesc') }}
          <span class="font-medium text-[#f2e2d2]">{{ email }}</span>
        </p>
      </div>
      ...
      <div
        ...
        class="rounded-xl border border-[#d08770]/20 bg-[#ebcb8b] p-4 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15"
      >
        <div class="flex items-start gap-3">
          <div class="flex-shrink-0">
            <Icon name="exclamationCircle" size="md" class="text-[#d08770]/80" />
          </div>
          <div class="text-sm text-[#d08770]/80 dark:text-[#d08770]">
      ...
      <form v-else @submit.prevent="handleVerify" class="space-y-5">
        ...
        <div
          v-if="codeSent"
          class="rounded-xl border border-[#a3be8c]/20 bg-[#a3be8c] p-4 dark:border-[#a3be8c]/25 dark:bg-[#a3be8c]/12"
        >
          <div class="flex items-start gap-3">
            <div class="flex-shrink-0">
              <Icon name="checkCircle" size="md" class="text-[#a3be8c]/80" />
            </div>
            <p class="text-sm text-[#a3be8c]/80 dark:text-[#a3be8c]">
        ...
        <div class="text-center">
          <button
            ...
            type="button"
            disabled
            class="cursor-not-allowed text-sm text-[#bda993]/70"
          >
          ...
          <button
            ...
            "
            class="text-sm text-neutral-300 transition-colors hover:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 dark:text-neutral-400 dark:hover:text-neutral-300"
          >
    ...
    <template #footer>
      <button
        @click="handleBack"
        class="flex items-center gap-2 text-[#bda993] transition-colors hover:text-[#f0ddc6]"
      >
