<template>
  <div class="min-h-screen bg-gray-50 px-4 py-10 dark:bg-[#0d0d0d]">
    <div class="mx-auto max-w-2xl">
      <div v-if="isProcessing" class="card p-6 text-center">
        <div class="mx-auto h-8 w-8 animate-spin rounded-full border-2 border-neutral-600/60 border-t-transparent"></div>
        <h1 class="mt-4 text-lg font-semibold text-neutral-100 dark:text-white">
      ...
      <div v-else-if="needsRegistrationCompletion" class="card p-6">
        <h1 class="text-lg font-semibold text-neutral-100 dark:text-white">
        ...
        <div class="mt-6 space-y-4">
          ...
          <p v-if="registrationError" class="text-sm text-[#bf616a]/80 dark:text-[#bf616a]">
            {{ registrationError }}
          </p>
          <button
