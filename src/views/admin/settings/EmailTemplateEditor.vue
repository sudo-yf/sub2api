<template>
  <div class="card">
    <div
      class="flex flex-col gap-3 border-b border-gray-100 px-6 py-4 dark:border-neutral-800/60 lg:flex-row lg:items-start lg:justify-between"
    >
      <div>
    ...
    <div class="space-y-6 p-6">
      ...
      <template v-else>
        ...
        <div
          ...
          class="rounded-lg border border-neutral-800/60 bg-neutral-900/30 p-4 dark:border-neutral-800/60 dark:bg-neutral-900/20"
        >
          <div class="flex flex-wrap items-center gap-2">
            <div class="text-sm font-semibold text-neutral-100 dark:text-white">
              {{ selectedEventMeta.label }}
            </div>
            <span
              class="rounded-full bg-white px-2.5 py-1 text-xs font-medium text-gray-600 shadow-sm ring-1 ring-gray-200 dark:bg-neutral-800 dark:text-neutral-300 dark:ring-dark-600"
            >
        ...
        <div
          ...
          class="rounded-lg border border-[#d08770]/20 bg-[#ebcb8b] p-4 text-sm text-[#d08770] dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]"
        >
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
          <div class="space-y-4">
            ...
            <div
              class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-neutral-800/60 dark:bg-neutral-800/60"
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-gray-200 bg-white px-3 py-1 font-mono text-xs text-gray-700 transition-colors hover:border-neutral-600/50 hover:text-neutral-200 dark:border-neutral-800/60 dark:bg-neutral-900 dark:text-neutral-500 dark:hover:border-neutral-500 dark:hover:text-neutral-300"
          ...
          <div class="space-y-4">
            <div
              class="rounded-lg border border-gray-200 bg-white dark:border-neutral-800/60 dark:bg-neutral-800"
            >
              <div
                class="flex items-center justify-between border-b border-gray-100 px-4 py-3 dark:border-neutral-800/60"
              >
                <div>
                  <div class="text-sm font-medium text-neutral-100 dark:text-white">
                ...
                <span
                  ...
                  class="rounded-full bg-neutral-900/40 px-2.5 py-1 text-xs font-medium text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-300"
                >
                  {{ t("admin.settings.emailTemplates.customized") }}
                </span>
              </div>
              <div class="bg-gray-100 p-3 dark:bg-[#0d0d0d]">
                <iframe
                  class="h-[36rem] w-full rounded-md border border-gray-200 bg-white dark:border-neutral-800/60"
                  sandbox=""
                  :srcdoc="previewHtml"
