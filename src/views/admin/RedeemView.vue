  ...
  <AppLayout>
    <TablePageLayout>
        ...
        >
          ...
          <template #cell-code="{ value }">
            <div class="flex items-center space-x-2">
              <code class="font-mono text-sm text-neutral-100">{{ value }}</code>
              <button
                ...
                :class="[
                  ...
                  copiedCode === value
                    ? 'text-[#a3be8c]/80'
                    : 'text-neutral-400 hover:text-gray-600 dark:hover:text-neutral-400'
                ]"
          ...
          <template #cell-value="{ value, row }">
            <span class="text-sm font-medium text-neutral-100">
              ...
              <template v-else-if="row.type === 'subscription'">
                ...
                <span v-if="row.group" class="ml-1 text-xs text-neutral-400"
                  >({{ row.group.name }})</span
                >
              </template>
      ...
      <template #pagination>
        <div
          ...
          class="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-lg bg-neutral-900/40 p-3 dark:bg-neutral-800/30"
        >
          <span class="text-sm font-medium text-neutral-100 dark:text-neutral-100">
            {{ t('admin.redeem.selectedCount', { count: selectedCount }) }}
          </span>
          <div class="flex flex-wrap items-center gap-2">
            <button
              type="button"
              class="text-xs font-medium text-neutral-200 hover:text-neutral-200 dark:text-neutral-300 dark:hover:text-neutral-200"
    ...
    <Teleport to="body">
      <div v-if="showGenerateDialog" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
          class="relative z-10 w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-neutral-800"
        >
          ...
          <form @submit.prevent="handleGenerateCodes" class="space-y-4">
            ...
            <!-- 邀请码类型：显示提示信息 -->
            <div v-if="generateForm.type === 'invitation'" class="rounded-lg bg-[#81a1c1]/12 p-3 dark:bg-[#81a1c1]/12">
                ...
                <button
                  ...
                  :class="[
                    ...
                    generateForm.expiry_option === option.value
                      ? 'border-neutral-600/60 bg-neutral-900/40 text-neutral-200 dark:border-neutral-600/50 dark:bg-neutral-800/30 dark:text-neutral-300'
                      : 'border-gray-200 text-gray-700 hover:bg-gray-50 dark:border-neutral-800/60 dark:text-neutral-300 dark:hover:bg-neutral-900'
                  ]"
                >
                  {{ option.label }}
                </button>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <div
          class="relative z-10 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl dark:bg-neutral-800"
        >
          <h2 class="mb-1 text-lg font-semibold text-neutral-100">
          ...
          <form data-test="batch-update-form" class="space-y-4" @submit.prevent="handleBatchUpdate">
            <div class="space-y-2">
              <label class="flex items-center gap-2 text-sm font-medium text-neutral-300">
                <input
    ...
    <Teleport to="body">
      <div v-if="showResultDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-white shadow-xl dark:bg-neutral-800">
          <!-- Header -->
          <div
            class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-neutral-800/60"
          >
            <div class="flex items-center gap-3">
              <div
                class="flex h-10 w-10 items-center justify-center rounded-full bg-[#a3be8c]/12 dark:bg-[#a3be8c]/12"
              >
                <svg
                  class="h-5 w-5 text-[#a3be8c]/80 dark:text-[#a3be8c]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <button
              ...
              class="rounded-lg p-1.5 text-neutral-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-neutral-900 dark:hover:text-neutral-400"
            >
          ...
          <div class="p-5">
            <div class="relative">
              <textarea
                ...
                class="w-full resize-none rounded-lg border border-gray-200 bg-gray-50 p-3 font-mono text-sm text-neutral-300 focus:outline-none dark:border-neutral-800/60 dark:bg-neutral-900 dark:text-neutral-500"
              ></textarea>
            </div>
          </div>
          <!-- Footer -->
          <div
            class="flex justify-end gap-2 rounded-b-xl border-t border-gray-200 bg-gray-50 px-5 py-4 dark:border-neutral-800/60 dark:bg-neutral-900/50"
          >
            <button
