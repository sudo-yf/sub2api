  ...
  <AppLayout>
          ...
          <div class="flex flex-1 flex-wrap items-center gap-3">
            ...
            >
              ...
              <button
                ...
                type="button"
                class="absolute right-2 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-gray-600 dark:hover:text-neutral-400"
              ...
              <div
                ...
                class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-[#1e1e1e]"
              >
                <div
                ...
                <button
                  ...
                  class="w-full px-4 py-2 text-left text-sm hover:bg-gray-100 dark:hover:bg-[#252525]"
                >
                  <span class="font-medium text-neutral-100">{{ user.email }}</span>
                  <span class="ml-2 text-neutral-400">#{{ user.id }}</span>
                </button>
              </div>
            </div>
          ...
          <div class="ml-auto flex flex-wrap items-center justify-end gap-3">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 z-50 mt-2 w-48 origin-top-right rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-[#1e1e1e]"
              >
                <div class="p-2">
                  <!-- User column mode selection -->
                  <div class="mb-2 border-b border-gray-200 pb-2 dark:border-gray-700">
                    <div class="px-3 py-1 text-xs font-medium text-neutral-400">
                    ...
                    >
                      ...
                      <Icon v-if="userColumnMode === 'email'" name="check" size="sm" class="text-neutral-500" />
                    </button>
                    <button
                    ...
                    >
                      ...
                      <Icon v-if="userColumnMode === 'username'" name="check" size="sm" class="text-neutral-500" />
                    </button>
                  </div>
        ...
        >
            ...
            <div class="min-w-[280px] space-y-2">
              ...
              <div v-if="row.group?.daily_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <div class="h-1.5 flex-1 rounded-full bg-gray-200 dark:bg-neutral-800">
                    <div
              ...
              >
                <span class="text-lg text-[#88c0d0]/80 dark:text-[#88c0d0]/80">∞</span>
                <span class="text-xs font-medium text-[#88c0d0]/80 dark:text-[#88c0d0]/80">
          ...
          <template #cell-expires_at="{ value }">
            <div v-if="value">
              ...
              <div v-if="getDaysRemaining(value) !== null" class="text-xs text-neutral-400">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-400 transition-colors hover:bg-[#81a1c1] hover:text-blue-400/70 dark:hover:bg-[#81a1c1]/15 dark:hover:text-blue-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-400 transition-colors hover:bg-[#ebcb8b] hover:text-orange-400/70 dark:hover:bg-[#d08770]/15 dark:hover:text-orange-400 disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-400 transition-colors hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#bf616a]/15 dark:hover:text-red-400"
              >
        ...
        <div>
          ...
          >
            <template #selected="{ option }">
              ...
              />
              <span v-else class="text-neutral-500">{{ t('admin.subscriptions.selectGroup') }}</span>
            </template>
    ...
    >
      <form
        ...
        class="space-y-5"
      >
        <div class="rounded-lg bg-gray-50 p-4 dark:bg-neutral-900">
          ...
          <p v-if="extendingSubscription.expires_at" class="mt-1 text-sm text-neutral-400">
    ...
    <teleport to="body">
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-2xl dark:bg-neutral-800">
            <button type="button" class="absolute right-4 top-4 text-neutral-500 hover:text-gray-600 dark:hover:text-neutral-500" @click="showGuideModal = false">
              <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
            </button>

            <h2 class="mb-4 text-lg font-bold text-neutral-100">{{ t('admin.subscriptions.guide.title') }}</h2>
            <p class="mb-5 text-sm text-neutral-400">{{ t('admin.subscriptions.guide.subtitle') }}</p>

            <!-- Step 1 -->
            <div class="mb-5">
              <h3 class="mb-2 flex items-center gap-2 text-sm font-semibold text-neutral-100">
                <span class="flex h-6 w-6 items-center justify-center rounded-full bg-neutral-800 text-xs font-bold text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-300">1</span>
                {{ t('admin.subscriptions.guide.step1.title') }}
              </h3>
              <ol class="ml-8 list-decimal space-y-1 text-sm text-neutral-300">
              ...
              <div class="ml-8 mt-2">
                <router-link
                  ...
                  class="inline-flex items-center gap-1 text-sm font-medium text-neutral-300 hover:text-neutral-200 dark:text-neutral-400 dark:hover:text-neutral-300"
                >
            ...
            <div class="mb-5">
              <h3 class="mb-2 flex items-center gap-2 text-sm font-semibold text-neutral-100">
                <span class="flex h-6 w-6 items-center justify-center rounded-full bg-neutral-800 text-xs font-bold text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-300">2</span>
            ...
            <div class="mb-5">
              <h3 class="mb-2 flex items-center gap-2 text-sm font-semibold text-neutral-100">
                <span class="flex h-6 w-6 items-center justify-center rounded-full bg-neutral-800 text-xs font-bold text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-300">3</span>
                {{ t('admin.subscriptions.guide.step3.title') }}
              </h3>
              <div class="ml-8 overflow-hidden rounded-lg border border-neutral-800/60">
                <table class="w-full text-sm">
                  <tbody>
                    <tr v-for="(row, i) in guideActionRows" :key="i" class="border-b border-neutral-800/60 last:border-0">
                      <td class="whitespace-nowrap bg-gray-50 px-3 py-2 font-medium text-gray-700 dark:bg-neutral-900 dark:text-neutral-300">{{ row.action }}</td>
                      <td class="px-3 py-2 text-neutral-400">{{ row.desc }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <!-- Tip -->
            <div class="rounded-lg bg-[#81a1c1]/12 p-3 text-xs text-white dark:bg-[#81a1c1]/12 dark:text-[#81a1c1]">
...
const getProgressClass = (used: number | null | undefined, limit: number | null): string => {
  ...
  if (percentage >= 90) return 'bg-[#bf616a]'
  if (percentage >= 70) return 'bg-[#ebcb8b]'
  return 'bg-[#a3be8c]'
}
...
.usage-label {
  @apply w-10 flex-shrink-0 text-xs font-medium text-neutral-400;
}

.usage-amount {
  @apply whitespace-nowrap text-xs tabular-nums text-neutral-300;
}
