  ...
  <AppLayout>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-[#a3be8c] hover:text-green-400/70 dark:hover:bg-[#a3be8c]/15 dark:hover:text-green-400"
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-[#81a1c1] hover:text-blue-400/70 dark:hover:bg-[#81a1c1]/15 dark:hover:text-blue-400"
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-gray-100 hover:text-neutral-400 dark:hover:bg-dark-600 dark:hover:text-neutral-400"
                :title="t('common.edit')"
              >
      ...
      <form id="create-promo-form" @submit.prevent="handleCreate" class="space-y-4">
        <div>
          <label class="input-label">
            {{ t('admin.promo.code') }}
            <span class="ml-1 text-xs font-normal text-neutral-400">({{ t('admin.promo.autoGenerate') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-neutral-400">({{ t('admin.promo.zeroUnlimited') }})</span>
          </label>
          <input
        ...
        <div>
          <label class="input-label">
            ...
            <span class="ml-1 text-xs font-normal text-neutral-400">({{ t('common.optional') }})</span>
          </label>
          <input
    ...
    >
      <div v-if="usagesLoading" class="flex items-center justify-center py-8">
        <Icon name="refresh" size="lg" class="animate-spin text-neutral-400" />
      </div>
      <div v-else-if="usages.length === 0" class="py-8 text-center text-neutral-400">
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="usage.id"
          class="flex items-center justify-between rounded-lg border border-gray-200 p-3 dark:border-neutral-800/60"
        >
          <div class="flex items-center gap-3">
            <div class="flex h-8 w-8 items-center justify-center rounded-full bg-[#a3be8c]/12 dark:bg-[#a3be8c]/12">
              <Icon name="user" size="sm" class="text-[#a3be8c]/80 dark:text-[#a3be8c]" />
            </div>
            <div>
          ...
          <div class="text-right">
            <span class="text-sm font-medium text-[#a3be8c]/80 dark:text-[#a3be8c]">
