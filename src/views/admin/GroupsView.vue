      ...
      <template #table>
        ...
        >
          ...
          <template #cell-platform="{ value }">
            <span
              :class="[
                ...
                value === 'anthropic'
                  ? 'bg-[#ebcb8b] text-neutral-800 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]'
                  : value === 'openai'
                    ? 'bg-[#a3be8c] text-neutral-800 dark:bg-[#a3be8c]/15 dark:text-[#a3be8c]'
                    : value === 'antigravity'
                      ? 'bg-[#b48ead] text-white dark:bg-[#b48ead]/12 dark:text-[#b48ead]'
                      : 'bg-[#81a1c1] text-white dark:bg-[#81a1c1]/12 dark:text-[#81a1c1]',
              ]"
            >
              ...
              <span
                :class="[
                  ...
                  row.subscription_type === 'subscription'
                    ? 'bg-[#b48ead]/12 text-[#b48ead] dark:bg-[#b48ead]/12 dark:text-[#b48ead]'
                    : 'bg-gray-100 text-gray-600 dark:bg-[#252525] dark:text-neutral-300',
                ]"
              >
                {{
                  row.subscription_type === "subscription"
              ...
              >
                ...
                >
                  ...
                  <span
                    ...
                    "
                    class="mx-1 text-neutral-400 dark:text-gray-600"
                    >·</span
                  >
                ...
                <span v-else class="text-neutral-400 dark:text-neutral-500">{{
          ...
          <template #cell-account_count="{ row }">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                <span
                  class="ml-1 font-medium text-[#88c0d0]/80 dark:text-[#88c0d0]/80"
                  >{{ row.active_account_count || 0 }}</span
                >
                <span
                  class="ml-1 inline-flex items-center rounded bg-gray-100 px-1.5 py-0.5 font-medium text-neutral-300 dark:bg-neutral-800 dark:text-neutral-300"
              ...
              <div v-if="row.rate_limited_account_count">
                ...
                <span
                  class="ml-1 font-medium text-[#d08770]/80 dark:text-[#d08770]"
              ...
              <div>
                ...
                <span
                  class="ml-1 font-medium text-neutral-300"
          ...
          <template #cell-usage="{ row }">
            <div v-if="usageLoading" class="text-xs text-neutral-400">—</div>
            <div v-else class="space-y-0.5 text-xs">
              <div class="text-neutral-400">
                <span class="text-neutral-400 dark:text-neutral-500">{{
                  t("admin.groups.usageToday")
                }}</span>
                <span class="ml-1 font-medium text-neutral-300"
                  >${{
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-gray-100 hover:text-neutral-200 dark:hover:bg-neutral-900 dark:hover:text-neutral-300"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-gray-100 hover:text-purple-400/70 dark:hover:bg-neutral-900 dark:hover:text-purple-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-gray-100 hover:text-orange-400/70 dark:hover:bg-neutral-900 dark:hover:text-orange-400"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#bf616a]/15 dark:hover:text-red-400"
              >
    ...
    >
      ...
      >
        ...
        <div v-if="copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-neutral-400 transition-colors hover:text-neutral-500 dark:text-neutral-500 dark:hover:text-neutral-300"
              />
              <div
              ...
              >
                <div
                  class="rounded-lg bg-neutral-900 p-3 text-white shadow-lg dark:bg-[#1e1e1e]"
                >
                  <p class="text-xs leading-relaxed text-neutral-400">
                    {{ t("admin.groups.copyAccounts.tooltip") }}
                  </p>
                  <div
                    class="absolute -bottom-1.5 left-3 h-3 w-3 rotate-45 bg-neutral-900 dark:bg-[#1e1e1e]"
                  ></div>
                </div>
              </div>
            </div>
          ...
          >
            <span
              ...
              :key="groupId"
              class="inline-flex items-center gap-1 rounded-full bg-neutral-800 px-2.5 py-1 text-xs font-medium text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-300"
            >
              {{
              ...
              <button
                ...
                "
                class="ml-0.5 text-neutral-500 hover:text-neutral-200 dark:hover:text-neutral-200"
              >
                <Icon name="x" size="xs" />
              </button>
            </span>
            ...
            <div class="group relative inline-flex">
              ...
              >
                ...
                >
                  ...
                  <p class="mb-2 text-xs leading-relaxed text-neutral-400">
                    {{ t("admin.groups.exclusiveTooltip.description") }}
                  </p>
                  <div class="rounded bg-[#1e1e1e] p-2 dark:bg-[#252525]">
                    <p class="text-xs leading-relaxed text-neutral-400">
                      <span
                        class="inline-flex items-center gap-1 text-neutral-400"
        ...
        <div class="mt-4 border-t pt-4">
          ...
          <div
            v-if="createForm.subscription_type === 'subscription'"
            class="space-y-4 border-l-2 border-neutral-700/50 pl-4 dark:border-neutral-700/50"
          >
            <div>
              <label class="input-label">{{
        ...
        >
          <label
            class="block mb-2 font-medium text-neutral-300"
          >
          ...
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            <label class="flex items-center gap-2 text-sm text-neutral-300">
              <input
                ...
                type="checkbox"
                class="rounded border-gray-300 text-[#81a1c1]/80 focus:ring-neutral-600"
              />
          ...
          <div class="mt-2 rounded-lg bg-gray-50 p-3 text-xs text-gray-700 dark:bg-[#1e1e1e] dark:text-neutral-300">
          ...
          <div class="space-y-2">
            <label class="flex items-center gap-2 cursor-pointer">
              <input
                ...
                class="h-4 w-4 rounded border-gray-300 text-neutral-300 focus:ring-neutral-500 dark:border-neutral-800/60 dark:bg-neutral-900"
              />
              <span class="text-sm text-neutral-300">{{
        ...
        >
          <h4 class="text-sm font-medium text-neutral-300 mb-3">
          ...
          <div v-if="createForm.allow_messages_dispatch" class="mt-3">
            <div
              class="relative overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-neutral-800/60 dark:bg-neutral-800"
            >
              <div
                class="border-b border-gray-100 bg-gray-50/80 px-4 py-3 dark:border-neutral-800/60 dark:bg-neutral-900/50"
              >
                <div class="flex items-center gap-2">
                  <div class="h-2 w-2 rounded-full bg-[#81a1c1]"></div>
                  <label
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-xl border border-neutral-700/50 bg-white shadow-sm dark:border-neutral-800/60 dark:bg-neutral-800"
            >
              <div
                class="border-b border-neutral-800/60 bg-neutral-900/40/80 px-4 py-3 dark:border-neutral-800/60 dark:bg-neutral-800/30"
              >
                <div class="flex items-start justify-between gap-3">
                  <div>
                    <div class="flex items-center gap-2">
                      ...
                      <label
                        class="text-sm font-medium text-neutral-100 dark:text-neutral-100"
                        >{{
                    ...
                    <p
                      class="mt-1 text-xs text-neutral-300/90 dark:text-neutral-400/90"
                    >
              ...
              <div class="p-4 bg-gray-50/30 dark:bg-neutral-800/30">
                <div
                  v-if="createForm.exact_model_mappings.length === 0"
                  class="flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-neutral-700/50 bg-white px-5 py-4 text-sm text-neutral-200 transition-colors hover:border-neutral-600/50 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:border-neutral-700/50"
                >
                  <span>{{
                  ...
                  <button
                    ...
                    class="flex items-center gap-1.5 text-sm font-medium text-neutral-300 transition-colors hover:text-neutral-200 dark:text-neutral-400 dark:hover:text-neutral-300"
                  >
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-all hover:border-neutral-600/50 hover:shadow-md dark:border-neutral-800/60 dark:bg-neutral-900 dark:hover:border-neutral-600/50"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-gray-50 focus:bg-[#141414] dark:focus:bg-[#0d0d0d]"
                          />
                        </div>
                        <div
                          class="hidden md:flex md:justify-center md:pt-7 text-neutral-300 dark:text-neutral-200"
                        >
                          <Icon
                            name="arrowRight"
                            size="sm"
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-lg text-neutral-400 transition-colors hover:bg-[#bf616a] hover:text-red-400/80 dark:hover:bg-[#bf616a]/15 dark:hover:text-red-400"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-300 bg-white py-3 text-sm font-medium text-neutral-500 transition-all hover:border-neutral-600/50 hover:bg-neutral-900/40 hover:text-neutral-200 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:border-neutral-700/50 dark:hover:bg-neutral-800/30 dark:hover:text-neutral-300"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <p
            ...
            class="text-xs text-neutral-400 mb-3"
          >
            {{ t("admin.groups.modelRouting.disabledHint") }}
          </p>
          <p v-else class="text-xs text-neutral-400 mb-3">
            ...
            >
              <div class="flex items-start gap-3">
                      ...
                      <div
                        v-if="
                          ...
                          accountSearchResults[getCreateRuleSearchKey(rule)]
                            ?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-lg border bg-white shadow-lg dark:border-neutral-800/60 dark:bg-neutral-800"
                      >
                        <button
                          ...
                          class="w-full px-3 py-2 text-left text-sm hover:bg-[#161616]"
                          :class="{
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-neutral-400 hover:text-red-400/80 transition-colors"
          ...
          <button
            ...
            class="mt-3 flex items-center gap-1.5 text-sm text-neutral-300 hover:text-neutral-200 dark:text-neutral-400 dark:hover:text-neutral-300"
          >
            <Icon name="plus" size="sm" />
      ...
      <div class="space-y-4">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-gray-200 bg-white p-3 transition-shadow hover:shadow-md active:cursor-grabbing dark:border-neutral-800/60 dark:bg-neutral-900"
          >
            <div class="text-neutral-400">
            ...
            <div class="text-sm text-neutral-400">#{{ group.id }}</div>
          </div>
        </VueDraggable>
      </div>
