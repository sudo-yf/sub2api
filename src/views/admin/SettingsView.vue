  ...
  <AppLayout>
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <div v-if="loading" class="flex items-center justify-center py-12">
        <div
          class="h-8 w-8 animate-spin rounded-full border-b-2 border-neutral-600"
        ></div>
      </div>
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div v-show="activeTab === 'security'" class="space-y-6">
          ...
          <div class="card">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-neutral-800/60"
            >
              <h2 class="text-lg font-semibold text-neutral-100 dark:text-white">
            ...
            <div class="space-y-4 p-6">
              <!-- Security Warning -->
              <div
                class="rounded-lg border border-[#d08770]/20 bg-[#ebcb8b] p-4 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15"
              >
                <div class="flex items-start">
                  <Icon
                    name="exclamationTriangle"
                    size="md"
                    class="mt-0.5 flex-shrink-0 text-[#d08770]/80"
                  />
                  <p class="ml-3 text-sm text-[#d08770]/80 dark:text-[#d08770]/70">
              ...
              >
                <div
                  class="h-4 w-4 animate-spin rounded-full border-b-2 border-neutral-600"
                ></div>
                {{ t("common.loading") }}
              </div>
              ...
              <div v-else class="space-y-4">
                <div class="flex items-center justify-between">
                  <div>
                    <label
                      class="mb-1 block text-sm font-medium text-neutral-600 dark:text-neutral-300"
                    >
                      {{ t("admin.settings.adminApiKey.currentKey") }}
                    </label>
                    <code
                      class="rounded bg-gray-100 px-2 py-1 font-mono text-sm text-gray-900 dark:bg-neutral-900 dark:text-neutral-500"
                    >
                      {{ adminApiKeyMasked }}
                    </code>
                  </div>
                  <div class="flex gap-2">
                    ...
                    <button
                      ...
                      :disabled="adminApiKeyOperating"
                      class="btn btn-secondary btn-sm text-[#bf616a]/80 hover:text-red-400/80 dark:text-[#bf616a]"
                    >
                ...
                <div
                  v-if="newAdminApiKey"
                  class="space-y-3 rounded-lg border border-[#a3be8c]/20 bg-[#a3be8c] p-4 dark:border-[#a3be8c]/25 dark:bg-[#a3be8c]/12"
                >
                  <p
                    class="text-sm font-medium text-[#a3be8c]/80 dark:text-[#a3be8c]"
                  >
                    {{ t("admin.settings.adminApiKey.keyWarning") }}
                  </p>
                  <div class="flex items-center gap-2">
                    <code
                      class="flex-1 select-all break-all rounded border border-[#a3be8c]/20 bg-white px-3 py-2 font-mono text-sm dark:border-[#a3be8c]/25 dark:bg-neutral-800"
                    >
                      {{ newAdminApiKey }}
                    </code>
                    <button
                  ...
                  <p class="text-xs text-[#a3be8c]/80 dark:text-[#a3be8c]">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    <label class="font-medium text-neutral-100 dark:text-white">{{
                ...
                <div
                  ...
                  class="space-y-4 border-t border-gray-100 pt-4 dark:border-neutral-800/60"
                >
                  <div>
                    <label
                      class="mb-2 block text-sm font-medium text-neutral-600 dark:text-neutral-300"
                    >
                ...
                <div
                  class="flex justify-end border-t border-gray-100 pt-4 dark:border-neutral-800/60"
                >
                  <button
                    type="button"
              ...
              <template v-else>
                ...
                >
                  ...
                  <div
                    ...
                    class="ml-4 space-y-3 border-l-2 border-gray-200 pl-4 dark:border-neutral-800/60"
                  >
                    <div>
                      <label
                        class="text-sm font-medium text-neutral-600 dark:text-neutral-300"
                    ...
                    >
                      ...
                      <button
                        ...
                        "
                        class="btn btn-ghost btn-xs text-[#bf616a]/80 hover:text-red-400/80"
                      >
                        <svg
                          class="h-4 w-4"
                          fill="none"
                    ...
                    <button
                      ...
                      class="btn btn-ghost btn-xs text-neutral-300 dark:text-neutral-400"
                    >
            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                ...
                <div
                  ...
                  :key="rule.beta_token"
                  class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60"
                >
                  <div class="mb-3 flex items-center gap-2">
                    <span
                      class="text-sm font-medium text-neutral-100 dark:text-white"
                    >
                      {{ getBetaDisplayName(rule.beta_token) }}
                    </span>
                    <span
                      class="rounded bg-gray-100 px-2 py-0.5 text-xs text-neutral-500 dark:bg-neutral-900 dark:text-neutral-400"
                    >
                      {{ rule.beta_token }}
                    </span>
                  </div>
                  ...
                  <div v-if="betaPresets[rule.beta_token]?.length" class="mt-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                      <button
                        ...
                        :key="preset.label"
                        type="button"
                        class="inline-flex items-center gap-1 rounded-md border border-neutral-700/50 bg-neutral-900/40 px-2.5 py-1 text-xs font-medium text-neutral-200 transition-colors hover:bg-neutral-800 dark:border-neutral-700/50 dark:bg-neutral-800/40 dark:text-neutral-300 dark:hover:bg-neutral-700/50"
                  ...
                  <div class="mt-3">
                    ...
                    >
                      ...
                      <button
                        ...
                        class="shrink-0 rounded p-1 text-[#bf616a]/80 transition-colors hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#bf616a]/15"
                      >
                        <svg
                          class="h-4 w-4"
                          fill="none"
                    ...
                    <button
                      ...
                      "
                      class="mb-2 inline-flex items-center gap-1 text-xs text-neutral-300 transition-colors hover:text-neutral-200 dark:text-neutral-400 dark:hover:text-neutral-300"
                    >
                      <svg
                        class="h-3.5 w-3.5"
                        fill="none"
                    ...
                    <div class="flex flex-wrap items-center gap-1.5">
                      ...
                      <button
                        ...
                        :key="pattern"
                        type="button"
                        class="rounded border border-gray-200 px-2 py-0.5 text-xs text-gray-600 transition-colors hover:border-neutral-600/50 hover:bg-neutral-900/40 hover:text-neutral-200 dark:border-neutral-800/60 dark:text-neutral-400 dark:hover:border-neutral-600/50 dark:hover:bg-neutral-800/40 dark:hover:text-neutral-300"
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div
                ...
                class="rounded-lg border border-dashed border-gray-200 p-6 text-center text-sm text-neutral-500 dark:border-neutral-800/60 dark:text-neutral-400"
              >
              ...
              >
                <div class="mb-3 flex items-center justify-between">
                  ...
                  <button
                    ...
                    class="rounded p-1 text-[#bf616a]/80 transition-colors hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#bf616a]/15"
        ...
        <div v-show="activeTab === 'security'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <!-- Email Verification -->
              <div
                class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-neutral-800/60"
              >
                <div>
                  <label class="font-medium text-neutral-100 dark:text-white">{{
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-neutral-800/60">
                <label class="font-medium text-neutral-100 dark:text-white">{{
                ...
                <div
                  class="mt-3 rounded-lg border border-gray-300 bg-white p-2 dark:border-neutral-700/60 dark:bg-neutral-900"
                >
                  <div class="flex flex-wrap items-center gap-2">
                    <span
                      v-for="suffix in registrationEmailSuffixWhitelistTags"
                      :key="suffix"
                      class="inline-flex items-center gap-1 rounded bg-gray-100 px-2 py-1 text-xs font-mono text-gray-700 dark:bg-neutral-800 dark:text-neutral-500"
                    >
                      <span>{{ suffix }}</span>
                      <button
                        type="button"
                        class="rounded-full text-neutral-500 hover:bg-gray-200 hover:text-neutral-600 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:hover:text-white"
                        @click="
                    ...
                    <div
                      class="flex min-w-[220px] flex-1 items-center gap-1 rounded border border-transparent px-2 py-1 focus-within:border-neutral-600/60 dark:focus-within:border-neutral-700/60"
                    >
                      <input
                        v-model="registrationEmailSuffixWhitelistDraft"
                        type="text"
                        class="w-full bg-transparent text-sm font-mono text-gray-900 outline-none placeholder:text-neutral-400 dark:text-white dark:placeholder:text-neutral-500"
                        :placeholder="
                          t(
              ...
              <div
                ...
                class="border-t border-gray-100 pt-4 dark:border-neutral-800/60"
              >
                <label
                  class="mb-2 block text-sm font-medium text-neutral-600 dark:text-neutral-300"
                >
              ...
              >
                <div>
                  ...
                  <p
                    ...
                    class="mt-2 text-sm text-[#d08770]/80 dark:text-[#d08770]"
                  >
                  ...
                  <div>
                    ...
                    >
                      ...
                      <code
                        ...
                        class="select-all break-all rounded bg-gray-50 px-2 py-1 font-mono text-xs text-gray-600 dark:bg-neutral-800 dark:text-neutral-300"
                      >
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              <div class="grid grid-cols-1 gap-6 xl:grid-cols-2">
                <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
                  <div class="flex items-start justify-between gap-4">
                    <div>
                      <h3 class="font-medium text-neutral-100 dark:text-white">
                        GitHub
                      </h3>
                      <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                        {{
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    <div class="rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-600 dark:bg-neutral-800 dark:text-neutral-300">
                      <template v-if="isZhLocale">
                        ...
                        <a
                          ...
                          class="font-medium text-neutral-300 hover:underline dark:text-neutral-400"
                        >OAuth Apps</a>
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      <div>
                        <label class="mb-2 block text-sm font-medium text-neutral-600 dark:text-neutral-300">Client ID</label>
                        <input
                      ...
                      <div>
                        <label class="mb-2 block text-sm font-medium text-neutral-600 dark:text-neutral-300">Client Secret</label>
                        <input
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div
                ...
                class="space-y-6 border-t border-gray-100 pt-4 dark:border-neutral-800/60"
              >
                <div class="space-y-4">
                  <div
                    class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60"
                ...
                <div
                  ...
                  "
                  class="rounded-lg border border-[#d08770]/20 bg-[#ebcb8b] px-4 py-3 text-sm text-[#d08770] dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]"
                >
                  {{
                    localText(
              ...
              >
                <div class="grid grid-cols-1 gap-6">
                  ...
                  <div
                    ...
                    class="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-neutral-800/60"
                  >
                    <div>
                      <label class="font-medium text-neutral-100 dark:text-white">{{
                  ...
                  <div
                    v-if="form.dingtalk_connect_corp_restriction_policy === 'internal_only'"
                    class="pt-4 border-t border-gray-100 dark:border-neutral-800/60 space-y-2"
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        <label class="font-medium text-neutral-100 dark:text-white">{{
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-gray-600 dark:text-neutral-400 whitespace-nowrap min-w-[5rem]">
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="text-xs text-neutral-400 dark:text-neutral-500">
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <div>
                        ...
                        <p class="text-xs text-[#d08770]/80 dark:text-[#d08770] mt-1">
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="text-xs text-neutral-400 dark:text-neutral-500">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="text-xs text-neutral-400 dark:text-neutral-500">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                  <div
                    class="flex items-center justify-between rounded border border-gray-200 px-4 py-3 dark:border-neutral-800/60"
                  >
                    <div>
                      <label class="font-medium text-neutral-100 dark:text-white">
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-neutral-800/60">
                ...
                <div
                  ...
                  class="rounded border border-dashed border-gray-300 px-4 py-3 text-sm text-neutral-500 dark:border-neutral-800/60 dark:text-neutral-400"
                >
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="grid grid-cols-1 gap-3 rounded border border-gray-200 p-3 md:grid-cols-[1fr_160px_auto] dark:border-neutral-800/60"
                  >
                    <div>
                      <label
                        class="mb-1 block text-xs font-medium text-gray-600 dark:text-neutral-400"
                    ...
                    <div class="flex items-end">
                      <button
                        type="button"
                        class="btn btn-secondary default-sub-delete-btn w-full text-[#bf616a]/80 hover:text-red-400/80 dark:text-[#bf616a]"
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="space-y-4">
                <div
                  ...
                  class="rounded-xl border border-gray-200 p-4 dark:border-neutral-800/60"
                >
                  <div class="flex items-center justify-between gap-4">
                    <div>
                      <div class="font-medium text-neutral-100 dark:text-white">
                        {{ authSource.title }}
                      </div>
                      <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                  ...
                  <div
                    ...
                    class="mt-4 space-y-4 border-t border-gray-100 pt-4 dark:border-neutral-800/60"
                  >
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    >
                      <div>
                        <label
                          class="font-medium text-neutral-100 dark:text-white"
                        >
                    ...
                    <div v-else class="space-y-3">
                      ...
                      >
                        ...
                        <div class="flex items-end">
                          <button
                            type="button"
                            class="btn btn-secondary w-full text-[#bf616a]/80 hover:text-red-400/80 dark:text-[#bf616a]"
                            @click="
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
            ...
            <div class="space-y-5 p-6">
              ...
              <div v-if="webSearchConfig.enabled" class="space-y-4">
                ...
                <div
                  ...
                  class="rounded-lg border border-dashed border-gray-300 p-4 text-center text-sm text-neutral-400 dark:border-neutral-800/60"
                >
                ...
                <div
                  ...
                  :key="pIdx"
                  class="rounded-lg border border-gray-200 dark:border-neutral-800/60"
                >
                  <!-- Collapsible header -->
                  <div
                  ...
                  >
                    ...
                    <button
                      type="button"
                      class="text-[#bf616a]/80 hover:text-red-400/80 text-xs"
                  ...
                  <div
                    ...
                    class="space-y-3 border-t border-gray-100 px-4 pb-4 pt-3 dark:border-neutral-800/60"
                  >
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        >
                          <button
                            type="button"
                            class="rounded p-1 text-neutral-400 hover:text-gray-600 dark:hover:text-neutral-400"
                            :title="
                              apiKeyVisible[pIdx]
                                ? t(
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <div
                        v-if="
                          ...
                          provider.quota_limit > 0
                        "
                        class="flex-1 rounded-full bg-gray-200 dark:bg-neutral-800"
                        style="height: 6px"
                      >
                        <div
                      ...
                      <button
                        ...
                        type="button"
                        class="text-xs text-neutral-300 hover:text-neutral-200"
          ...
          >
            <div
              class="mx-4 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl dark:bg-neutral-800"
            >
              <h3
                class="mb-4 text-lg font-semibold text-neutral-100 dark:text-white"
              >
              ...
              <div
                v-if="wsTestResult"
                class="mt-4 max-h-80 overflow-y-auto rounded-lg bg-gray-50 p-4 dark:bg-neutral-900"
              >
                <p
                  class="mb-2 text-sm font-medium text-neutral-600 dark:text-neutral-300"
                >
                  {{
                ...
                <div
                  ...
                  :key="rIdx"
                  class="mt-2 border-t border-gray-200 pt-2 first:mt-0 first:border-0 first:pt-0 dark:border-neutral-800/60"
                >
                  <a
                    :href="r.url"
                    target="_blank"
                    class="text-sm font-medium text-[#81a1c1]/80 hover:underline dark:text-[#81a1c1]"
                    >{{ r.title }}</a
                  >
                  <p class="mt-0.5 text-xs text-neutral-500 dark:text-neutral-400">
                    {{ r.snippet }}
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              <!-- Backend Mode -->
              <div
                class="flex items-center justify-between rounded-lg border border-[#d08770]/20 bg-[#ebcb8b] p-4 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15"
              >
                <div>
                  <h3 class="text-sm font-medium text-neutral-100 dark:text-white">
              ...
              <div>
                ...
                <div class="space-y-3">
                  ...
                  >
                    <div class="mb-3 flex items-center justify-between">
                      ...
                      <button
                        type="button"
                        class="rounded p-1 text-[#bf616a]/80 hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#bf616a]/15"
                ...
                <button
                  type="button"
                  class="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-300 px-4 py-2.5 text-sm text-neutral-500 transition-colors hover:border-neutral-500 hover:text-neutral-200 dark:border-neutral-800/60 dark:text-neutral-400 dark:hover:border-neutral-500 dark:hover:text-neutral-300"
                  @click="addEndpoint"
                >
                  <svg
                    class="h-4 w-4"
              ...
              <div>
                ...
                <!-- iframe CSP Warning -->
                <p class="mt-2 text-xs text-[#d08770]/80 dark:text-[#d08770]">
          ...
          <div class="card">
            ...
            <div class="space-y-4 p-6">
                ...
                <div class="mb-3 flex items-center justify-between">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      v-if="index > 0"
                      type="button"
                      class="rounded p-1 text-neutral-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-neutral-900"
              ...
              <button
                type="button"
                class="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-300 py-3 text-sm text-neutral-500 transition-colors hover:border-neutral-500 hover:text-neutral-200 dark:border-neutral-800/60 dark:text-neutral-400 dark:hover:border-neutral-500 dark:hover:text-neutral-300"
                @click="addMenuItem"
              >
                <svg
                  class="h-4 w-4"
	        ...
	        <div v-show="activeTab === 'agreement'" class="space-y-6">
	          <div class="card">
	            <div class="border-b border-gray-100 px-6 py-4 dark:border-neutral-800/60">
	            ...
	            <div class="space-y-6 p-6">
	              <div class="grid grid-cols-1 gap-5 lg:grid-cols-[minmax(0,1fr)_220px]">
	                <div>
	                  ...
	                  <div class="grid grid-cols-2 gap-2 rounded-lg bg-gray-100 p-1 dark:bg-neutral-900">
                    <button
                      type="button"
                      class="inline-flex items-center justify-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition"
                      :class="
                        form.login_agreement_mode === 'modal'
                          ? 'bg-white text-neutral-200 shadow-sm dark:bg-neutral-800 dark:text-neutral-300'
              ...
              <div>
                ...
                <div class="mt-4 space-y-3">
                  <div
                    ...
                    :key="doc.id || index"
                    class="rounded-lg border border-gray-200 bg-white p-4 dark:border-neutral-800/60 dark:bg-neutral-800/60"
                  >
                    <div class="mb-3 flex items-center justify-between gap-3">
                      <div class="flex min-w-0 items-center gap-3">
                        <span class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md bg-gray-100 text-gray-700 dark:bg-neutral-900 dark:text-neutral-200">
                          <Icon
                            :name="
                              index === 1
                                ? 'shield'
                        ...
                        <div class="min-w-0">
                          <p class="truncate text-sm font-semibold text-neutral-100 dark:text-white">
                      ...
                      <button
                        type="button"
                        class="rounded-md p-2 text-[#bf616a]/80 transition hover:bg-[#bf616a] hover:text-red-400/70 disabled:cursor-not-allowed disabled:opacity-40 dark:hover:bg-[#bf616a]/15"
                        :disabled="
                    ...
                    <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                      <div>
                        <label class="mb-1 block text-xs font-medium text-gray-600 dark:text-neutral-400">
                      ...
                      <div>
                        ...
                        <div class="flex overflow-hidden rounded-lg border border-gray-300 bg-white focus-within:border-neutral-600/60 focus-within:ring-1 focus-within:ring-neutral-500 dark:border-neutral-800/60 dark:bg-[#0d0d0d]">
                          <span class="inline-flex flex-shrink-0 items-center border-r border-gray-200 bg-gray-50 px-3 text-sm text-neutral-500 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-400">
                            /legal/
                          </span>
                          <input
                            v-model="doc.id"
                            type="text"
                            class="min-w-0 flex-1 border-0 bg-transparent px-3 py-2 text-sm text-gray-900 outline-none placeholder:text-neutral-400 focus:ring-0 dark:text-white dark:placeholder:text-dark-500"
          ...
          <div class="border-b border-gray-100 px-6 py-4 dark:border-neutral-800/60">
            ...
            <p class="mt-1.5 text-xs">
              <router-link
                ...
                class="inline-flex items-center gap-1 text-neutral-300 hover:underline dark:text-neutral-400"
              >
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.channel_monitor_enabled">
              <label class="input-label">
                ...
                <span class="text-[#bf616a]/80">*</span>
              </label>
              <input
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              ...
              <!-- 专属用户管理 -->
              <div class="border-t border-gray-100 pt-6 dark:border-neutral-800/60">
                <div class="mb-3 flex items-center justify-between">
                  <div>
                    <h3 class="text-sm font-semibold text-neutral-100 dark:text-white">
                ...
                <div class="overflow-hidden rounded-lg border border-neutral-800/60">
                  <table class="min-w-full divide-y divide-neutral-800/60">
                    <thead class="bg-[#0d0d0d]">
                      <tr>
                        ...
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-neutral-400">{{ t('admin.settings.features.affiliate.customUsers.col.email') }}</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-neutral-400">{{ t('admin.settings.features.affiliate.customUsers.col.username') }}</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-neutral-400">{{ t('admin.settings.features.affiliate.customUsers.col.code') }}</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-neutral-400">{{ t('admin.settings.features.affiliate.customUsers.col.rate') }}</th>
                        <th class="px-3 py-2 text-left text-xs font-medium uppercase text-neutral-400">{{ t('admin.settings.features.affiliate.customUsers.col.actions') }}</th>
                      </tr>
                    </thead>
                    <tbody class="divide-y divide-neutral-800/60 bg-[#0d0d0d]">
                      ...
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-neutral-100 dark:text-white">{{ entry.email }}</td>
                        <td class="px-3 py-2 text-sm text-gray-600 dark:text-neutral-300">{{ entry.username }}</td>
                        <td class="px-3 py-2 text-sm font-mono">
                          {{ entry.aff_code }}
                          <span
                            v-if="entry.aff_code_custom"
                            class="ml-1 inline-block rounded bg-neutral-800 px-1.5 py-0.5 text-[10px] font-medium text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-300"
                        ...
                        <td class="px-3 py-2 text-sm">
                          ...
                          <span v-else class="text-neutral-400">{{ t('admin.settings.features.affiliate.customUsers.useGlobal') }}</span>
                        </td>
                        <td class="px-3 py-2 text-sm">
                          <div class="flex items-center gap-2">
                            <button type="button" class="text-neutral-300 hover:underline" @click="openAffiliateModal(entry)">
                              {{ t('common.edit') }}
                            </button>
                            <button
                              type="button"
                              class="text-[#bf616a]/80 hover:underline"
                ...
                <div v-if="affiliateState.total > affiliateState.pageSize" class="mt-3 flex items-center justify-between text-sm">
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <span class="text-neutral-500">{{ affiliateState.page }} / {{ Math.max(1, Math.ceil(affiliateState.total / affiliateState.pageSize)) }}</span>
                    <button
                      type="button"
                      class="btn btn-secondary btn-sm"
        ...
        >
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-[#0d0d0d]">
            ...
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                ...
                <div
                  ...
                  class="flex items-center justify-between rounded-md border border-neutral-700/50 bg-neutral-900/40 px-3 py-2 dark:border-neutral-700/40 dark:bg-neutral-800/30"
                >
                  <div class="text-sm">
                    <span class="font-medium text-neutral-100 dark:text-white">{{ affiliateModal.selectedUser.email }}</span>
                    <span class="ml-1 text-xs text-neutral-500">({{ affiliateModal.selectedUser.username }})</span>
                  </div>
                  <button
                    type="button"
                    class="text-lg leading-none text-neutral-400 hover:text-red-400/70"
                ...
                <template v-else>
                  ...
                  <div
                    ...
                    class="mt-1 max-h-40 overflow-y-auto rounded border border-gray-200 dark:border-neutral-800/60"
                  >
                    <button
                      v-for="u in affiliateModal.userResults"
                      :key="u.id"
                      type="button"
                      class="w-full px-3 py-1.5 text-left text-sm hover:bg-gray-100 dark:hover:bg-neutral-800"
                      @click="selectAffiliateUser(u)"
                    >
                      {{ u.email }} <span class="text-xs text-neutral-500">({{ u.username }})</span>
                    </button>
                  </div>
                </template>
              </div>
            ...
            >
              ...
              <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="ml-2 inline-flex items-center text-neutral-300 hover:text-neutral-200 dark:text-neutral-400 dark:hover:text-neutral-300"
                >
                  <svg
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <div
                      class="rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-600 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-300"
                    >
                      {{
                ...
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-5">
                  ...
                  <div>
                    ...
                    <p
                      class="mt-1 text-xs font-medium text-neutral-300 dark:text-neutral-400"
                    >
                      {{
                  ...
                  <div>
                    <label class="input-label"
                      ...
                      <span class="text-[#bf616a]/80">*</span></label
                    ><input
                ...
                <div>
                    ...
                    <button
                      ...
                      :class="[
                        ...
                        isPaymentTypeEnabled(pt.value)
                          ? 'border-neutral-600/60 bg-neutral-600 text-white shadow-sm'
                          : 'border-gray-300 bg-white text-gray-600 hover:border-gray-400 hover:bg-gray-50 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:border-neutral-600/60',
                      ]"
                    >
                      {{ pt.label }}
                    </button>
                  ...
                  <p class="mt-2 text-xs text-neutral-400 dark:text-neutral-500">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="ml-1 text-neutral-500 hover:text-neutral-200 dark:text-neutral-400 dark:hover:text-neutral-300"
                    >
        ...
        <div v-show="activeTab === 'email'" class="space-y-6">
            ...
            <div class="p-6">
              <div class="flex items-start gap-3">
                <Icon
                  name="mail"
                  size="md"
                  class="mt-0.5 flex-shrink-0 text-neutral-400 dark:text-neutral-500"
                />
                <div>
                  <h3 class="font-medium text-neutral-100 dark:text-white">
          ...
          <div v-if="form.email_verify_enabled" class="card">
            <div
              class="flex items-center justify-between border-b border-gray-100 px-6 py-4 dark:border-neutral-800/60"
            >
              <div>
                <h2 class="text-lg font-semibold text-neutral-100 dark:text-white">
          ...
          <div class="card">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-neutral-800/60"
            >
              <h3 class="text-base font-medium text-neutral-100 dark:text-white">
            ...
            <div class="px-6 py-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <label
                    class="mb-0 block text-sm font-medium text-neutral-600 dark:text-neutral-300"
                  >
...
.settings-tab {
  @apply relative isolate flex h-10 min-w-[6.75rem] shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl border border-transparent px-3 text-sm font-medium text-gray-600 outline-none transition-colors duration-200 ease-out dark:text-neutral-300;
}
...
.settings-tab:focus-visible {
  @apply ring-2 ring-neutral-600/40 ring-offset-2 ring-offset-white dark:ring-offset-[#0a0a0a];
}

.settings-tab-active {
  @apply border-neutral-700/50 bg-white text-neutral-200 shadow-sm dark:border-neutral-600/50 dark:bg-neutral-900/95 dark:text-neutral-200;
  box-shadow:
...
.settings-tab-icon {
  @apply flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-gray-500 transition-colors duration-200 dark:text-neutral-400;
}
...
.settings-tab-active .settings-tab-icon {
  @apply bg-neutral-900/40 text-neutral-300 dark:bg-neutral-500/10 dark:text-neutral-300;
}
