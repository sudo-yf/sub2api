...
export function getSeverityClass(severity: OpsSeverity): string {
  const classes: Record<string, string> = {
    P0: 'bg-[#bf616a]/8 text-[#bf616a]/80 dark:bg-[#bf616a]/12 dark:text-[#bf616a]',
    P1: 'bg-[#d08770]/8 text-[#d08770]/80 dark:bg-[#d08770]/12 dark:text-[#d08770]',
    P2: 'bg-[#ebcb8b]/8 text-[#ebcb8b]/80 dark:bg-[#ebcb8b]/12 dark:text-[#ebcb8b]',
    P3: 'bg-[#81a1c1]/8 text-[#81a1c1]/80 dark:bg-[#81a1c1]/12 dark:text-[#81a1c1]'
  }
