...
<template>
  <section class="card p-4 md:p-5">
    ...
    <div v-if="errorMessage" class="mb-4 rounded-lg bg-[#bf616a]/12 px-3 py-2 text-xs text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]">
      {{ errorMessage }}
    </div>
    ...
    <div v-else class="space-y-3">
      <div class="overflow-hidden rounded-xl border border-neutral-800/60">
        <div class="max-h-[420px] overflow-auto">
          <table class="min-w-full text-left text-xs md:text-sm">
            <thead class="sticky top-0 z-10 bg-[#141414]">
              <tr class="border-b border-gray-200 text-neutral-500 dark:border-neutral-800/60 dark:text-neutral-400">
            ...
            <tbody>
              <tr
                v-for="row in items"
                :key="row.model"
                class="border-b border-gray-100 text-gray-700 last:border-b-0 dark:border-neutral-800/60 dark:text-neutral-500"
              >
      ...
      <div v-if="viewMode === 'topn'" class="mt-3 text-xs text-neutral-400">
