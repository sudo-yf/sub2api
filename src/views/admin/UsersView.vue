  ...
  <AppLayout>
            ...
            <div class="flex items-center gap-2 md:contents">
              ...
              <div class="relative" ref="filterDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 w-48 rounded-lg border border-gray-200 bg-white py-1 shadow-lg dark:border-neutral-800/60 dark:bg-neutral-800"
                >
                  <!-- Built-in filters -->
                  <button
                    ...
                    class="flex w-full items-center justify-between px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-neutral-300 dark:hover:bg-neutral-900"
                  >
                  ...
                  <div
                    ...
                    class="my-1 border-t border-neutral-800/60"
                  ></div>
              ...
              <div class="relative" ref="columnDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-lg border border-gray-200 bg-white py-1 shadow-lg dark:border-neutral-800/60 dark:bg-neutral-800"
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ...
                        : 'text-gray-700 hover:bg-gray-100 dark:text-neutral-300 dark:hover:bg-neutral-900'
                    ]"
                  ...
                  >
                    ...
                    <Icon
                      ...
                      name="check"
                      size="sm"
                      :class="isForcedVisibleColumn(col.key) ? 'text-neutral-400 dark:text-neutral-500' : 'text-neutral-500'"
                      :stroke-width="2"
                    />
                  </button>
                </div>
        ...
        >
          <template #cell-email="{ value }">
            <div class="flex items-center gap-2">
              <div
                class="flex h-8 w-8 items-center justify-center rounded-full bg-neutral-800 dark:bg-neutral-800/40"
              >
                <span class="text-sm font-medium text-neutral-200 dark:text-neutral-300">
          ...
          <template #cell-notes="{ value }">
            <div class="max-w-xs">
              <span
                ...
                class="block truncate text-sm text-neutral-400"
              >
          ...
          >
            <div class="max-w-xs">
              <span
                class="block truncate text-sm text-neutral-300"
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                <Icon name="shield" size="xs" class="h-3.5 w-3.5 text-[#b48ead]/80 dark:text-[#b48ead]" />
                <span class="font-medium text-[#b48ead]/80 dark:text-[#b48ead]">{{ getUserGroups(row).exclusive.length }}</span>
                <span class="text-neutral-400">{{ t('admin.users.exclusiveLabel') }}</span>
                <!-- Hover tooltip（操作菜单未打开时显示） -->
                <div
                  v-if="expandedGroupUserId !== row.id"
                  class="pointer-events-none absolute left-0 top-full z-50 mt-1.5 rounded bg-neutral-900 px-2.5 py-1.5 text-xs text-white opacity-0 shadow-lg transition-opacity duration-75 group-hover/ex:opacity-100 dark:bg-neutral-800"
                >
                ...
                <div
                  v-if="expandedGroupUserId === row.id"
                  class="absolute left-0 top-full z-50 mt-1.5 min-w-[160px] overflow-hidden rounded-lg border border-gray-200 bg-white py-1 text-xs shadow-xl dark:border-neutral-800/60 dark:bg-neutral-900"
                >
                  <div class="border-b border-gray-100 px-3 py-1.5 text-[10px] font-medium uppercase tracking-wider text-neutral-400 dark:border-neutral-800/60 dark:text-neutral-400">
                    {{ t('admin.users.clickToReplace') }}
                  </div>
                  <div
                    v-for="g in getUserGroups(row).exclusive"
                    :key="g.id"
                    class="flex cursor-pointer items-center gap-2 px-3 py-2 text-gray-700 transition-colors hover:bg-neutral-900/40 hover:text-neutral-200 dark:text-neutral-200 dark:hover:bg-neutral-800/40 dark:hover:text-neutral-300"
              ...
              >
                <Icon name="globe" size="xs" class="h-3.5 w-3.5 text-neutral-500" />
                <span class="font-medium text-neutral-300">{{ getUserGroups(row).publicGroups.length }}</span>
                <span class="text-neutral-500">{{ t('admin.users.publicLabel') }}</span>
                <!-- Tooltip: 向下弹出 -->
                <div class="pointer-events-none absolute left-0 top-full z-50 mt-1.5 rounded bg-neutral-900 px-2.5 py-1.5 text-xs text-white opacity-0 shadow-lg transition-opacity duration-75 group-hover/pub:opacity-100 dark:bg-neutral-800">
                  <div class="absolute left-4 bottom-full border-4 border-transparent border-b-gray-900 dark:border-b-dark-600"></div>
                  <div class="flex flex-col gap-0.5 whitespace-nowrap">
          ...
          <template #cell-subscriptions="{ row }">
            ...
            <span
              v-else
              class="inline-flex items-center gap-1.5 rounded-md bg-gray-50 px-2 py-1 text-xs text-neutral-400 dark:bg-neutral-900/50 dark:text-neutral-500"
            >
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                <button
                  class="font-medium text-gray-900 underline decoration-dashed decoration-gray-300 underline-offset-4 transition-colors hover:text-neutral-200 dark:text-white dark:decoration-dark-500 dark:hover:text-neutral-300"
                  @click="handleBalanceHistory(row)"
                >
                  ${{ value.toFixed(2) }}
                </button>
                <!-- Instant tooltip -->
                <div class="pointer-events-none absolute bottom-full left-1/2 z-50 mb-1.5 -translate-x-1/2 whitespace-nowrap rounded bg-neutral-900 px-2 py-1 text-xs text-white opacity-0 shadow-lg transition-opacity duration-75 group-hover:opacity-100 dark:bg-neutral-800">
              ...
              <button
                ...
                class="rounded px-2 py-0.5 text-xs font-medium text-[#a3be8c] transition-colors hover:bg-[#a3be8c] dark:text-[#a3be8c] dark:hover:bg-[#88c0d0]/15"
          ...
          >
            <div class="flex items-center gap-1.5">
              ...
              <div class="usage-sort-trigger relative">
                <button
                  type="button"
                  class="flex items-center gap-1 rounded px-1 py-0.5 transition-colors hover:bg-gray-200 dark:hover:bg-neutral-900"
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 min-w-[120px] rounded-lg border border-gray-200 bg-white py-1 shadow-lg dark:border-neutral-800/60 dark:bg-neutral-800"
                >
                  <button
                    v-for="metric in (['today', 'total'] as const)"
                    :key="metric"
                    type="button"
                    class="flex w-full items-center justify-between gap-3 px-3 py-1.5 text-left text-xs normal-case tracking-normal hover:bg-[#161616]"
                    :class="isUsageSortActive(usageKey, metric)
                      ? 'font-medium text-neutral-300 dark:text-neutral-400'
                      : 'text-neutral-300'"
                  ...
                  <div class="mt-1 border-t border-gray-100 px-3 py-1 text-[10px] normal-case tracking-normal text-neutral-400 dark:border-neutral-800/60 dark:text-neutral-500">
            ...
            <div class="flex items-center gap-1.5">
              <span
                :class="[
                  ...
                  value === 'active' ? 'bg-[#a3be8c]' : 'bg-[#bf616a]'
                ]"
              ></span>
          ...
          <template #cell-created_at="{ value }">
            <span class="text-sm text-neutral-400">{{ formatDateTime(value) }}</span>
          </template>
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors',
                  row.status === 'active'
                    ? 'hover:bg-[#ebcb8b] hover:text-orange-400/70 dark:hover:bg-[#d08770]/15 dark:hover:text-orange-400'
                    : 'hover:bg-[#a3be8c] hover:text-green-400/70 dark:hover:bg-[#a3be8c]/15 dark:hover:text-green-400'
                ]"
              >
              ...
              <button
                ...
                class="action-menu-trigger flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-neutral-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-neutral-900 dark:hover:text-white"
                :class="{ 'bg-gray-100 text-gray-900 dark:bg-neutral-900 dark:text-white': activeMenuId === row.id }"
              >
    ...
    <Teleport to="body">
      <div
        ...
        class="action-menu-content fixed z-[9999] w-48 overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-black/5 dark:bg-neutral-800 dark:ring-white/10"
          ...
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-neutral-300 dark:hover:bg-neutral-900"
              >
                <Icon name="key" size="sm" class="text-neutral-400" :stroke-width="2" />
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-neutral-300 dark:hover:bg-neutral-900"
              >
                <Icon name="users" size="sm" class="text-neutral-400" :stroke-width="2" />
                {{ t('admin.users.groups') }}
              </button>

              <div class="my-1 border-t border-neutral-800/60"></div>
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-neutral-300 dark:hover:bg-neutral-900"
              >
                <Icon name="dollar" size="sm" class="text-neutral-400" :stroke-width="2" />
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-[#bf616a]/80 hover:bg-[#bf616a] dark:text-[#bf616a] dark:hover:bg-[#bf616a]/15"
              >
