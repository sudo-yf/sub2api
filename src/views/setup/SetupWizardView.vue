  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-neutral-700 to-neutral-800 shadow-lg"
        >
          <Icon name="cog" size="xl" class="text-white" />
        </div>
        <h1 class="text-3xl font-bold text-neutral-100 dark:text-white">{{ t('setup.title') }}</h1>
        <p class="mt-2 text-neutral-500 dark:text-neutral-400">{{ t('setup.description') }}</p>
      </div>
        ...
        <div class="flex items-center justify-center">
          <template v-for="(step, index) in steps" :key="step.id">
              ...
              <div
                :class="[
                  ...
                  currentStep > index
                    ...
                    : currentStep === index
                      ? 'bg-neutral-600 text-white ring-4 ring-neutral-700/40 dark:ring-neutral-700/50'
                      : 'bg-gray-200 text-neutral-500 dark:bg-neutral-900 dark:text-neutral-400'
                ]"
              >
                <Icon
            ...
            <div
              ...
              :class="currentStep > index ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-900'"
            ></div>
          </template>
        </div>
      </div>
      ...
      <div class="rounded-2xl bg-white p-8 shadow-xl dark:bg-neutral-800">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          <div class="mb-6 text-center">
            <h2 class="text-xl font-semibold text-neutral-100 dark:text-white">
          ...
          <div class="flex items-center justify-between rounded-xl border border-gray-200 p-3 dark:border-neutral-800/60">
            <div>
          ...
          >
            ...
            <Icon v-else-if="dbConnected" name="check" size="md" class="mr-2 text-[#a3be8c]/80" :stroke-width="2" />
            {{
              testingDb
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-neutral-900">
              <h3 class="mb-2 text-sm font-medium text-neutral-500 dark:text-neutral-400">
                {{ t('setup.ready.database') }}
              </h3>
              <p class="text-neutral-100 dark:text-white">
            ...
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-neutral-900">
              ...
              <p class="text-neutral-100 dark:text-white">{{ formData.admin.email }}</p>
            </div>
          </div>
        </div>
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-xl border border-[#bf616a]/20 bg-[#bf616a] p-4 dark:border-[#bf616a]/25 dark:bg-[#bf616a]/12"
        >
          <div class="flex items-start gap-3">
            <Icon name="exclamationCircle" size="md" class="flex-shrink-0 text-[#bf616a]/80" />
            <p class="text-sm text-[#bf616a]/80 dark:text-[#bf616a]">{{ errorMessage }}</p>
          </div>
        </div>
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-[#a3be8c]/20 bg-[#a3be8c] p-4 dark:border-[#a3be8c]/25 dark:bg-[#a3be8c]/12"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
              class="h-5 w-5 flex-shrink-0 animate-spin text-[#a3be8c]/80"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <Icon v-else name="checkCircle" size="md" class="flex-shrink-0 text-[#a3be8c]/80" />
            <div>
              <p class="text-sm font-medium text-[#a3be8c]/80 dark:text-[#a3be8c]">
                {{ t('setup.status.completed') }}
              </p>
              <p class="mt-1 text-sm text-[#a3be8c]/80 dark:text-[#a3be8c]/80">
                {{
                  serviceReady
