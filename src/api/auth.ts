...
import {
  getPreviewCurrentUserResponse,
  getPreviewPublicSettings,
...
export async function getCurrentUser() {
  if (isDevWuiPreviewEnabled()) {
    return Promise.resolve({ data: getPreviewCurrentUserResponse() })
  }
...
export async function getPublicSettings(): Promise<PublicSettings> {
  if (isDevWuiPreviewEnabled()) {
    return Promise.resolve(getPreviewPublicSettings())
  }
