<template>
  <div class="card p-4">
        ...
        <table class="w-full text-xs">
          ...
          <tbody>
            <template v-for="item in displayEndpointStats" :key="item.endpoint">
              ...
              >
                <td class="max-w-[180px] truncate py-1.5 font-medium text-[#81a1c1]/80 hover:text-blue-400/80 dark:text-[#81a1c1] dark:hover:text-blue-400/70" :title="item.endpoint">
    ...
    <div v-else class="flex h-48 items-center justify-center text-sm text-neutral-400">
