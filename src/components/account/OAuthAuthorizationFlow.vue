<template>
  <div
    class="rounded-lg border border-[#81a1c1]/20 bg-[#81a1c1] p-4 dark:border-[#81a1c1]/25 dark:bg-[#81a1c1]/12"
  >
      <div class="flex items-start gap-4">
      <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#81a1c1]">
        <Icon name="link" size="md" class="text-white" />
      </div>
      <div class="flex-1">
        <h4 class="mb-3 font-semibold text-[#81a1c1]/80 dark:text-[#81a1c1]/70">{{ oauthTitle }}</h4>

        <!-- Auth Method Selection -->
        <div v-if="showMethodSelection" class="mb-4">
          <label class="mb-2 block text-sm font-medium text-[#81a1c1]/80 dark:text-[#81a1c1]">
            {{ methodLabel }}
          </label>
          <div class="flex flex-wrap gap-4">
            <label class="flex cursor-pointer items-center gap-2">
              <input
                ...
                type="radio"
                value="manual"
                class="text-[#81a1c1]/80 focus:ring-neutral-600"
              />
              <span class="text-sm text-[#81a1c1]/80 dark:text-[#81a1c1]/70">{{
        ...
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="space-y-4">
          <div
            class="rounded-lg border border-[#81a1c1]/20 bg-white/80 p-4 dark:border-[#81a1c1]/25 dark:bg-[#1e1e1e]/80"
          >
            <p class="mb-3 text-sm text-[#81a1c1]/80 dark:text-[#81a1c1]">
            ...
            <div class="mb-4">
              ...
              >
                <Icon name="key" size="sm" class="text-[#81a1c1]/80" />
                Refresh Token
                <span
                  v-if="parsedRefreshTokenCount > 1"
                  class="rounded-full bg-[#81a1c1] px-2 py-0.5 text-xs text-white"
                >
              ...
              <p
                v-if="parsedRefreshTokenCount > 1"
                class="mt-1 text-xs text-[#81a1c1]/80 dark:text-[#81a1c1]"
              >
            ...
            <div
              v-if="error"
              class="mb-4 rounded-lg border border-[#bf616a]/20 bg-[#bf616a] p-3 dark:border-[#bf616a]/25 dark:bg-[#bf616a]/12"
            >
              <p class="whitespace-pre-line text-sm text-[#bf616a]/80 dark:text-[#bf616a]">
                {{ error }}
              </p>
            </div>
          ...
          >
            ...
            <div class="mb-4">
              ...
              <textarea
                ...
                spellcheck="false"
              ></textarea>
              <p class="mt-1 text-xs text-[#81a1c1]/80 dark:text-[#81a1c1]">
        ...
        <div v-if="inputMethod === 'cookie'" class="space-y-4">
          ...
          >
            ...
            <div class="mb-4">
              ...
              >
                ...
                <button
                  v-if="showHelp"
                  type="button"
                  class="text-[#81a1c1]/80 hover:text-blue-400/70"
            ...
            <div
              ...
              class="mb-4 rounded-lg border border-[#d08770]/20 bg-[#ebcb8b] p-3 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15"
            >
              <h5 class="mb-2 font-semibold text-[#d08770]/80 dark:text-[#d08770]/60">
                {{ t('admin.accounts.oauth.howToGetSessionKey') }}
              </h5>
              <ol
                class="list-inside list-decimal space-y-1 text-xs text-[#d08770]/80 dark:text-[#d08770]/70"
              >
              ...
              <p
                class="mt-2 text-xs text-[#d08770]/80 dark:text-[#d08770]"
        ...
        <div v-if="inputMethod === 'manual'" class="space-y-4">
          <p class="mb-4 text-sm text-[#81a1c1]/80 dark:text-[#81a1c1]">
            {{ oauthFollowSteps }}
          </p>
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                <p class="mb-2 font-medium text-[#81a1c1]/80 dark:text-[#81a1c1]/70">
                ...
                <div v-if="showProjectId && platform === 'gemini'" class="mb-3">
                  <label class="input-label flex items-center gap-2">
                    ...
                    <a
                      ...
                      class="inline-flex items-center gap-1 text-xs font-normal text-[#81a1c1]/80 hover:text-blue-400/70 dark:text-[#81a1c1]"
                    >
                ...
                <div v-else class="space-y-3">
                  <div class="flex items-center gap-2">
                    <input
                      ...
                      readonly
                      type="text"
                      class="input flex-1 bg-gray-50 font-mono text-xs dark:bg-[#252525]"
                    />
                    <button
                      type="button"
                  ...
                  <button
                    type="button"
                    class="text-xs text-[#81a1c1]/80 hover:text-blue-400/80 dark:text-[#81a1c1]"
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <div
                  v-if="isOpenAI"
                  class="mt-2 rounded border border-[#d08770]/20 bg-[#ebcb8b] p-3 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15"
                >
                  <p
                    class="text-xs text-[#d08770]/80 dark:text-[#d08770]/70"
                ...
                <div
                  ...
                  class="mt-2 rounded border border-[#ebcb8b]/20 bg-[#ebcb8b] p-3 dark:border-[#ebcb8b]/25 dark:bg-[#ebcb8b]/12"
                >
                  <p
                    class="text-xs text-[#ebcb8b]/80 dark:text-[#ebcb8b]"
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <p
                  class="mb-3 text-sm text-[#81a1c1]/80 dark:text-[#81a1c1]"
                  v-text="oauthAuthCodeDesc"
                ></p>
                <div>
                  <label class="input-label">
                    <Icon name="key" size="sm" class="mr-1 inline text-[#81a1c1]/80" />
                    {{ oauthAuthCode }}
                  </label>
                  <textarea
                  ...
                  <div
                    ...
                    class="mt-3 rounded-lg border-2 border-[#d08770]/20 bg-[#ebcb8b] p-3 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15"
                  >
                    <div class="flex items-start gap-2">
                      <Icon
                        name="exclamationTriangle"
                        size="md"
                        class="flex-shrink-0 text-[#d08770]/80 dark:text-[#d08770]"
                        :stroke-width="2"
                      />
                      <div class="text-sm text-[#d08770]/80 dark:text-[#d08770]/70">
                ...
                <div
                  v-if="error"
                  class="mt-3 rounded-lg border border-[#bf616a]/20 bg-[#bf616a] p-3 dark:border-[#bf616a]/25 dark:bg-[#bf616a]/12"
                >
                  <p class="whitespace-pre-line text-sm text-[#bf616a]/80 dark:text-[#bf616a]">
                    {{ error }}
                  </p>
