  ...
  >
    ...
    >
      ...
      <div v-if="account.type === 'apikey'" class="space-y-4">
        ...
        <div v-if="account.platform !== 'antigravity'" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            ...
            <div class="flex flex-wrap gap-1.5">
              ...
              <span v-if="selectedErrorCodes.length === 0" class="text-xs text-neutral-400">
      ...
      <div v-if="account.platform === 'antigravity'" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        ...
        <div>
          <div class="mb-3 rounded-lg bg-[#b48ead]/12 p-3 dark:bg-[#b48ead]/12">
            <p class="text-xs text-[#b48ead]/80 dark:text-[#b48ead]">{{ t('admin.accounts.mapRequestModels') }}</p>
          </div>
          ...
          <div class="mb-3 flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg border border-[#88c0d0]/20 px-3 py-1.5 text-sm text-[#a3be8c] hover:bg-[#a3be8c] disabled:cursor-not-allowed disabled:opacity-60 dark:border-[#88c0d0]/25 dark:text-[#a3be8c] dark:hover:bg-[#88c0d0]/15"
            >
            ...
            >
              <div class="flex items-center gap-2">
                <input
                  ...
                  :placeholder="t('admin.accounts.requestModel')"
                />
                <svg class="h-4 w-4 flex-shrink-0 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          ...
          <div v-if="tempUnschedRules.length > 0" class="space-y-3">
            <div
              ...
              class="rounded-lg border border-gray-200 p-3 dark:border-neutral-800/60"
            >
              <div class="mb-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-neutral-400 transition-colors hover:text-gray-600 disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-neutral-500"
                  >
      ...
      <div
        ...
        class="border-t border-gray-200 pt-4 dark:border-neutral-800/60"
      >
        <div class="overflow-hidden rounded-lg border border-[#81a1c1]/20 bg-sky-50/60 shadow-sm dark:border-[#81a1c1]/25 dark:bg-[#81a1c1]/12">
          <div class="flex items-start gap-3 px-4 py-3">
            <div class="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-white text-[#81a1c1]/80 shadow-sm ring-1 ring-sky-100 dark:bg-neutral-800 dark:text-[#81a1c1] dark:ring-sky-900/60">
          ...
          <div class="border-t border-[#81a1c1]/20 bg-white/70 p-2 dark:border-[#81a1c1]/25 dark:bg-neutral-800/70">
              ...
              <button
                ...
                :class="[
                  ...
                  codexImageGenerationBridgeMode === option.value
                    ? 'border-[#81a1c1]/20 bg-sky-50 text-[#81a1c1]/80 shadow-sm ring-1 ring-sky-200 dark:border-[#81a1c1]/25 dark:bg-[#81a1c1]/12 dark:text-[#81a1c1] dark:ring-sky-800'
                    : 'border-transparent bg-transparent text-slate-600 hover:border-gray-200 hover:bg-gray-50 dark:text-slate-300 dark:hover:border-neutral-600/60 dark:hover:bg-neutral-900'
                ]"
              >
                <span
                  :class="[
                    ...
                    codexImageGenerationBridgeMode === option.value
                      ? 'border-[#81a1c1]/20 bg-sky-500 text-white'
                      : 'border-gray-300 text-transparent group-hover:border-gray-400 dark:border-neutral-700/60'
                  ]"
                >
      ...
      <div
        ...
        class="border-t border-gray-200 pt-4 dark:border-neutral-800/60 space-y-3"
      >
        ...
        <div class="rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-600 dark:bg-neutral-900 dark:text-neutral-300">
        ...
        <div v-if="account?.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-not-allowed items-center gap-2 opacity-60">
            <input
              ...
              disabled
              class="h-4 w-4 cursor-not-allowed rounded border-gray-300 text-neutral-500 focus:ring-neutral-500 dark:border-neutral-700/60"
            />
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-gray-200 text-xs text-neutral-500 hover:bg-gray-300 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
...
const codexImageGenerationBridgeBadgeClass = computed(() => {
  switch (codexImageGenerationBridgeMode.value) {
    ...
    case 'disabled':
      return 'bg-[#b48ead]/8 text-[#b48ead]/80 dark:bg-[#b48ead]/12 dark:text-[#b48ead]'
    default:
