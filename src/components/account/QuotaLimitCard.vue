...
<template>
  <div class="rounded-lg border border-gray-200 dark:border-neutral-800/60">
      ...
      <div class="flex items-center justify-between p-4" :class="{ 'pb-0': localEnabled && !collapsed }">
        <div class="flex items-center gap-2 flex-1 cursor-pointer" @click="localEnabled && (collapsed = !collapsed)">
          <svg v-if="localEnabled" class="h-4 w-4 text-neutral-400 transition-transform" :class="{ '-rotate-90': collapsed }" viewBox="0 0 20 20" fill="currentColor">
        ...
        <button
          ...
          :class="[
            ...
            localEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
          ]"
        >
          <span
            :class="[
