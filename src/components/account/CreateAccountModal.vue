  ...
  >
        ...
        <div class="flex items-center">
          <div
            :class="[
              ...
              step >= 1 ? 'bg-neutral-600 text-white' : 'bg-gray-200 text-neutral-400 dark:bg-neutral-800'
            ]"
          >
            1
          </div>
          <span class="ml-2 text-sm font-medium text-neutral-300">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-0.5 w-8 bg-gray-300 dark:bg-neutral-800" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-8 w-8 items-center justify-center rounded-full text-sm font-semibold',
              step >= 2 ? 'bg-neutral-600 text-white' : 'bg-gray-200 text-neutral-400 dark:bg-neutral-800'
            ]"
          >
            2
          </div>
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex rounded-lg bg-gray-100 p-1 dark:bg-neutral-900" data-tour="account-form-platform">
          <button
            type="button"
            ...
            :class="[
              ...
              form.platform === 'anthropic'
                ? 'bg-white text-[#d08770]/80 shadow-sm dark:bg-neutral-800 dark:text-[#d08770]'
                : 'text-gray-600 hover:text-gray-900 dark:text-neutral-400 dark:hover:text-neutral-500'
            ]"
          >
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'openai'
                ? 'bg-white text-[#a3be8c]/80 shadow-sm dark:bg-neutral-800 dark:text-[#a3be8c]'
                : 'text-gray-600 hover:text-gray-900 dark:text-neutral-400 dark:hover:text-neutral-500'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'gemini'
                ? 'bg-white text-[#81a1c1]/80 shadow-sm dark:bg-neutral-800 dark:text-[#81a1c1]'
                : 'text-gray-600 hover:text-gray-900 dark:text-neutral-400 dark:hover:text-neutral-500'
            ]"
          >
            <svg
          ...
          <button
            ...
            :class="[
              ...
              form.platform === 'antigravity'
                ? 'bg-white text-[#b48ead]/80 shadow-sm dark:bg-neutral-800 dark:text-[#b48ead]'
                : 'text-gray-600 hover:text-gray-900 dark:text-neutral-400 dark:hover:text-neutral-500'
            ]"
          >
      ...
      <div v-if="form.platform === 'anthropic'">
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ? 'border-[#d08770]/20 bg-[#ebcb8b] dark:bg-[#ebcb8b]/15'
                : 'border-gray-200 hover:border-[#d08770]/20 dark:border-neutral-800/60 dark:hover:border-[#d08770]/20'
            ]"
          >
            <div
              :class="[
                ...
                accountCategory === 'oauth-based'
                  ? 'bg-[#ebcb8b] text-white'
                  : 'bg-gray-100 text-neutral-400 dark:bg-neutral-800 dark:text-neutral-400'
              ]"
            >
              <Icon name="sparkles" size="sm" />
            </div>
            <div>
              <span class="block text-sm font-medium text-neutral-100">{{
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ? 'border-[#b48ead]/20 bg-[#b48ead] dark:bg-[#b48ead]/12'
                : 'border-gray-200 hover:border-[#b48ead]/20 dark:border-neutral-800/60 dark:hover:border-[#b48ead]/20'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ? 'border-[#81a1c1]/20 bg-sky-50 dark:bg-[#81a1c1]/12'
                : 'border-gray-200 hover:border-[#81a1c1]/20 dark:border-neutral-800/60 dark:hover:border-[#81a1c1]/20'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-neutral-100">Vertex</span>
              <span class="text-xs text-neutral-400">Service Account</span>
            </div>
          </button>
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-[#81a1c1]/20 bg-sky-50 px-3 py-2 text-xs text-[#81a1c1]/80 dark:border-[#81a1c1]/25 dark:bg-[#81a1c1]/12 dark:text-[#81a1c1]"
        >
        ...
        <div class="mt-2 grid grid-cols-2 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              'flex items-center gap-3 rounded-lg border-2 p-3 text-left transition-all',
              accountCategory === 'oauth-based'
                ? 'border-[#a3be8c]/20 bg-[#a3be8c] dark:bg-[#a3be8c]/12'
                : 'border-gray-200 hover:border-[#a3be8c]/20 dark:border-neutral-800/60 dark:hover:border-[#a3be8c]/20'
            ]"
          >
            <div
              :class="[
            ...
            <div>
              <span class="block text-sm font-medium text-neutral-100">OAuth</span>
              <span class="text-xs text-neutral-400">{{ t('admin.accounts.types.chatgptOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-neutral-100">API Key</span>
              <span class="text-xs text-neutral-400">{{ t('admin.accounts.types.responsesApi') }}</span>
            </div>
          </button>
      ...
      <div v-if="form.platform === 'gemini'">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="flex items-center gap-1 rounded px-2 py-1 text-xs text-[#81a1c1]/80 hover:bg-[#81a1c1] dark:text-[#81a1c1] dark:hover:bg-[#81a1c1]/15"
          >
        ...
        <div class="mt-2 grid grid-cols-3 gap-3" data-tour="account-form-type">
          <button
            ...
            :class="[
              'flex items-center gap-3 rounded-lg border-2 p-3 text-left transition-all',
              accountCategory === 'oauth-based'
                ? 'border-[#81a1c1]/20 bg-[#81a1c1] dark:bg-[#81a1c1]/12'
                : 'border-gray-200 hover:border-[#81a1c1]/20 dark:border-neutral-800/60 dark:hover:border-[#81a1c1]/20'
            ]"
          >
            <div
        ...
        <div
          ...
          class="mt-3 rounded-lg border border-[#b48ead]/20 bg-[#b48ead] px-3 py-2 text-xs text-white dark:border-[#b48ead]/25 dark:bg-[#b48ead]/12 dark:text-[#b48ead]/70"
        >
          <p>{{ t('admin.accounts.gemini.accountType.apiKeyNote') }}</p>
          <div class="mt-2 flex flex-wrap gap-2">
            <a
              :href="geminiHelpLinks.apiKey"
              class="font-medium text-[#81a1c1]/80 hover:underline dark:text-[#81a1c1]"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-[#b48ead]/12 px-2 py-0.5 text-[10px] font-semibold text-white dark:bg-[#b48ead]/12 dark:text-[#b48ead]"
                  >
                    推荐个人用户
                  </span>
                  <span
                    class="rounded bg-[#a3be8c] px-2 py-0.5 text-[10px] font-semibold text-[#a3be8c] dark:bg-[#a3be8c]/15 dark:text-[#a3be8c]"
                  >
                    无需 GCP
                  </span>
                </div>
              ...
              <div class="min-w-0">
                ...
                <div class="mt-1 text-xs text-neutral-400">
                  ...
                  <a
                    ...
                    class="ml-1 text-[#81a1c1]/80 hover:underline dark:text-[#81a1c1]"
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-[#81a1c1]/12 px-2 py-0.5 text-[10px] font-semibold text-white dark:bg-[#81a1c1]/12 dark:text-[#81a1c1]"
                  >
                    企业用户
                  </span>
                  <span
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 dark:text-neutral-400 dark:hover:text-neutral-500"
            >
              <svg
          ...
          <div v-if="showAdvancedOAuth" class="mt-3 group relative">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded bg-[#ebcb8b] px-2 py-0.5 text-[10px] font-semibold text-[#d08770] dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]"
                  >
              ...
              <span
                ...
                class="ml-auto shrink-0 rounded bg-[#ebcb8b] px-2 py-0.5 text-xs text-[#d08770] dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]"
              >
            ...
            <div
              v-if="!geminiAIStudioOAuthEnabled"
              class="pointer-events-none absolute right-0 top-full z-50 mt-2 w-80 rounded-md border border-[#d08770]/20 bg-[#ebcb8b] px-3 py-2 text-xs text-[#d08770] opacity-0 shadow-lg transition-opacity group-hover:opacity-100 dark:border-[#d08770]/25 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]"
            >
      ...
      <div v-if="form.platform === 'antigravity'">
        ...
        <div class="mt-2 grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-neutral-100">OAuth</span>
              <span class="text-xs text-neutral-400">{{ t('admin.accounts.types.antigravityOauth') }}</span>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <span class="block text-sm font-medium text-neutral-100">API Key</span>
              <span class="text-xs text-neutral-400">{{ t('admin.accounts.types.antigravityApikey') }}</span>
            </div>
          </button>
        </div>
      </div>
        ...
        <div>
          ...
          <div
            :class="[
              ...
              vertexServiceAccountDragActive
                ? 'border-[#81a1c1]/20 bg-sky-50 dark:border-[#81a1c1]/25 dark:bg-[#81a1c1]/12'
                : 'border-gray-300 bg-gray-50 hover:border-[#81a1c1]/20 hover:bg-[#81a1c1]/15 dark:border-neutral-700/60 dark:bg-neutral-900/40 dark:hover:border-[#81a1c1]/20 dark:hover:bg-[#81a1c1]/15'
            ]"
          ...
          >
            ...
            <div
              ...
              class="mt-3 rounded-md border border-[#81a1c1]/20 bg-white px-3 py-2 text-xs text-[#81a1c1]/80 dark:border-[#81a1c1]/25 dark:bg-neutral-800 dark:text-[#81a1c1]"
            >
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>

        <!-- Mapping Mode Only (no toggle for Antigravity) -->
        <div>
          <div class="mb-3 rounded-lg bg-[#b48ead]/12 p-3 dark:bg-[#b48ead]/12">
            <p class="text-xs text-[#b48ead]/80 dark:text-[#b48ead]">
            ...
            >
              <div class="flex items-center gap-2">
                <input
                  ...
                  :class="[
                    'input flex-1',
                    !isValidWildcardPattern(mapping.from) ? 'border-[#bf616a]/20 dark:border-[#bf616a]/25' : ''
                  ]"
                  :placeholder="t('admin.accounts.requestModel')"
                />
                <svg class="h-4 w-4 flex-shrink-0 text-neutral-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <input
                  ...
                  :class="[
                    'input flex-1',
                    mapping.to.includes('*') ? 'border-[#bf616a]/20 dark:border-[#bf616a]/25' : ''
                  ]"
                ...
                <button
                  ...
                  class="rounded-lg p-2 text-[#bf616a]/80 transition-colors hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#bf616a]/15"
                >
              ...
              <!-- 校验错误提示 -->
              <p v-if="!isValidWildcardPattern(mapping.from)" class="text-xs text-[#bf616a]/80">
                {{ t('admin.accounts.wildcardOnlyAtEnd') }}
              </p>
              <p v-if="mapping.to.includes('*')" class="text-xs text-[#bf616a]/80">
          ...
          <button
            ...
            class="mb-3 w-full rounded-lg border-2 border-dashed border-gray-300 px-4 py-2 text-gray-600 transition-colors hover:border-gray-400 hover:text-neutral-400 dark:border-neutral-700/60 dark:text-neutral-400 dark:hover:border-dark-400 dark:hover:text-neutral-400"
          >
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            <input
              ...
              type="radio"
              value="oauth"
              class="mr-2 text-neutral-300 focus:ring-neutral-500"
            />
            <span class="text-sm text-neutral-300">{{ t('admin.accounts.types.oauth') }}</span>
          </label>
          <label class="flex cursor-pointer items-center">
            <input
              v-model="addMethod"
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
          <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>

          <div
            v-if="isOpenAIModelRestrictionDisabled"
            class="mb-3 rounded-lg bg-[#ebcb8b]/12 p-3 dark:bg-[#ebcb8b]/15"
          >
            <p class="text-xs text-[#d08770]/80 dark:text-[#d08770]">
              ...
              <button
                ...
                :class="[
                  ...
                  modelRestrictionMode === 'whitelist'
                    ? 'bg-neutral-800 text-neutral-200 dark:bg-neutral-800/40 dark:text-neutral-400'
              ...
              <button
                ...
                :class="[
                  ...
                  modelRestrictionMode === 'mapping'
                    ? 'bg-[#b48ead] text-white dark:bg-[#b48ead]/12 dark:text-[#b48ead]'
                    : 'bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700'
                ]"
              >
                <svg
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                ...
                poolModeEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="poolModeEnabled" class="rounded-lg bg-[#81a1c1]/12 p-3 dark:bg-[#81a1c1]/12">
            <p class="text-xs text-[#81a1c1]/80 dark:text-[#81a1c1]">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                customErrorCodesEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            <div class="rounded-lg bg-[#ebcb8b]/12 p-3 dark:bg-[#ebcb8b]/15">
              <p class="text-xs text-[#d08770]/80 dark:text-[#d08770]">
              ...
              <button
                ...
                :class="[
                  ...
                  selectedErrorCodes.includes(code.value)
                    ? 'bg-[#bf616a] text-white ring-1 ring-red-500 dark:bg-[#bf616a]/12 dark:text-[#bf616a]'
                    : 'bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700'
                ]"
              >
            ...
            <div class="flex flex-wrap gap-1.5">
              <span
                ...
                :key="code"
                class="inline-flex items-center gap-1 rounded-full bg-[#bf616a]/12 px-2.5 py-0.5 text-sm font-medium text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]"
              >
                {{ code }}
                <button
                  type="button"
                  @click="removeErrorCode(code)"
                  class="hover:text-red-400/70 dark:hover:text-red-300"
                >
                  <Icon name="x" size="sm" :stroke-width="2" />
                </button>
              </span>
              <span v-if="selectedErrorCodes.length === 0" class="text-xs text-neutral-500">
          ...
          <div class="mt-2 flex gap-4">
            <label class="flex cursor-pointer items-center">
              <input
                ...
                class="mr-2 text-neutral-300 focus:ring-neutral-500"
              />
              <span class="text-sm text-neutral-300">{{ t('admin.accounts.bedrockAuthModeSigv4') }}</span>
            </label>
            <label class="flex cursor-pointer items-center">
              <input
                v-model="bedrockAuthMode"
                ...
                class="mr-2 text-neutral-300 focus:ring-neutral-500"
              />
              <span class="text-sm text-neutral-300">{{ t('admin.accounts.bedrockAuthModeApikey') }}</span>
            </label>
          </div>
        </div>
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              type="checkbox"
              class="rounded border-gray-300 text-neutral-300 focus:ring-neutral-500 dark:border-neutral-700/60"
            />
            <span class="text-sm text-neutral-300">{{ t('admin.accounts.bedrockForceGlobal') }}</span>
          </label>
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
          ...
          <div v-else class="space-y-3">
            <div v-for="(mapping, index) in modelMappings" :key="index" class="flex items-center gap-2">
              ...
              <button type="button" @click="modelMappings.splice(index, 1)" class="text-[#bf616a]/80 hover:text-red-400/80">
      ...
      <div
        ...
        class="border-t border-gray-200 pt-4 dark:border-neutral-800/60 space-y-4"
      >
        <div class="mb-3">
      ...
      <div
        ...
        class="border-t border-gray-200 pt-4 dark:border-neutral-800/60"
      >
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
              tempUnschedEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          <div class="rounded-lg bg-[#81a1c1]/12 p-3 dark:bg-[#81a1c1]/12">
              <p class="text-xs text-[#81a1c1]/80 dark:text-[#81a1c1]">
                <Icon name="exclamationTriangle" size="sm" class="mr-1 inline" :stroke-width="2" />
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-lg bg-gray-100 px-3 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:bg-gray-200 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <div v-if="tempUnschedRules.length > 0" class="space-y-3">
            <div
              ...
              class="rounded-lg border border-neutral-800/60 p-3"
            >
              <div class="mb-2 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                  <button
                    ...
                    class="rounded p-1 text-neutral-500 transition-colors hover:text-gray-600 disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-neutral-500"
                  >
                  ...
                  <button
                    ...
                    class="rounded p-1 text-[#bf616a]/80 transition-colors hover:text-red-400/70"
                  >
                    <Icon name="x" size="sm" :stroke-width="2" />
                  </button>
                </div>
          ...
          <button
            ...
            class="w-full rounded-lg border-2 border-dashed border-gray-300 px-4 py-2 text-sm text-gray-600 transition-colors hover:border-gray-400 hover:text-neutral-400 dark:border-neutral-700/60 dark:text-neutral-400 dark:hover:border-dark-400 dark:hover:text-neutral-400"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
              interceptWarmupRequests ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
            ]"
          >
            <span
              :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                windowCostEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                sessionLimitEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="sessionLimitEnabled" class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="relative">
                ...
                />
                <span class="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400">{{ t('common.minutes') }}</span>
              </div>
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                rpmLimitEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
          ...
          <div class="mt-4">
            ...
            <p class="mt-1 text-xs text-neutral-400 mb-2">
              ...
              <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
                ...
                :class="[
                  ...
                  userMsgQueueMode === opt.value
                    ...
                    : 'bg-[#0d0d0d] text-neutral-300 border-gray-300 dark:border-neutral-700/60 hover:bg-gray-50 dark:hover:bg-dark-600'
                ]">
                {{ opt.label }}
              </button>
            </div>
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                tlsFingerprintEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                sessionIdMaskingEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                cacheTTLOverrideEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="cacheTTLOverrideEnabled" class="mt-3">
            ...
            <select
              ...
              class="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-neutral-500 focus:outline-none focus:ring-1 focus:ring-neutral-500 dark:border-neutral-700/60 dark:bg-neutral-900 dark:text-white"
            >
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
                customBaseUrlEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
              openaiPassthroughEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
              anthropicPassthroughEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
              codexCLIOnlyEnabled ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
            ]"
          >
            <span
              :class="[
        ...
        <div>
          ...
          <div v-if="openAICompactModelMappings.length > 0" class="mb-3 space-y-2">
            ...
            >
              ...
              <span class="text-neutral-500">→</span>
              <input v-model="mapping.to" type="text" class="input flex-1" :placeholder="t('admin.accounts.toModel')" />
              <button type="button" @click="removeOpenAICompactModelMapping(index)" class="text-[#bf616a]/80 hover:text-red-400/80">
                <Icon name="trash" size="sm" />
              </button>
            </div>
          </div>
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2',
              autoPauseOnExpired ? 'bg-neutral-600' : 'bg-gray-200 dark:bg-neutral-800'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              ...
              class="h-4 w-4 rounded border-gray-300 text-neutral-500 focus:ring-neutral-500 dark:border-neutral-700/60"
            />
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-gray-200 text-xs text-neutral-400 hover:bg-gray-300 dark:bg-neutral-800 dark:text-neutral-400 dark:hover:bg-neutral-700"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded bg-neutral-900 px-3 py-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 dark:bg-[#252525]"
            >
  ...
  >
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-4">
          <div>
            <p class="mb-2 text-sm font-medium text-neutral-300">
          ...
          <div>
            ...
            <div class="mt-2 flex flex-wrap gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                class="text-sm text-[#81a1c1]/80 hover:underline dark:text-[#81a1c1]"
              >
      ...
      <div class="border-t border-gray-200 pt-6 dark:border-neutral-800/60">
        <h3 class="mb-3 text-sm font-semibold text-neutral-100">
          {{ t('admin.accounts.gemini.quotaPolicy.title') }}
        </h3>
        <p class="mb-4 text-xs text-[#d08770]/80 dark:text-[#d08770]">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="bg-[#0d0d0d]">
              <tr>
                <th class="px-3 py-2 text-left font-medium text-neutral-300">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-dark-600">
              <tr>
                ...
                <td class="px-3 py-2 text-neutral-400">Free</td>
                <td class="px-3 py-2 text-neutral-400">
                  {{ t('admin.accounts.gemini.quotaPolicy.rows.googleOne.limitsFree') }}
                </td>
              </tr>
              <tr>
                <td class="px-3 py-2 text-neutral-100"></td>
                <td class="px-3 py-2 text-neutral-400">Pro</td>
                <td class="px-3 py-2 text-neutral-400">
              ...
              <tr>
                <td class="px-3 py-2 text-neutral-100"></td>
                <td class="px-3 py-2 text-neutral-400">Ultra</td>
                <td class="px-3 py-2 text-neutral-400">
              ...
              <tr>
                ...
                <td class="px-3 py-2 text-neutral-400">Standard</td>
                <td class="px-3 py-2 text-neutral-400">
              ...
              <tr>
                <td class="px-3 py-2 text-neutral-100"></td>
                <td class="px-3 py-2 text-neutral-400">Enterprise</td>
                <td class="px-3 py-2 text-neutral-400">
              ...
              <tr>
                <td class="px-3 py-2 text-neutral-100"></td>
                <td class="px-3 py-2 text-neutral-400">Paid</td>
                <td class="px-3 py-2 text-neutral-400">
