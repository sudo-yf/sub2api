<template>
  <div>
    ...
    >
      <div class="flex items-center gap-1.5 text-[9px] text-neutral-500 dark:text-neutral-400">
    ...
    <div class="flex items-center gap-1">
      ...
      <div class="h-1.5 w-8 shrink-0 overflow-hidden rounded-full bg-gray-200 dark:bg-[#252525]">
        <div
      ...
      <!-- Reset time -->
      <span v-if="shouldShowResetTime" class="shrink-0 text-[10px] text-neutral-400">
        {{ formatResetTime }}
      </span>
    </div>
  </div>
...
const labelClass = computed(() => {
  const colors = {
    indigo: 'bg-[#5e81ac]/8 text-[#5e81ac]/80 dark:bg-[#5e81ac]/12 dark:text-[#5e81ac]',
    emerald: 'bg-[#a3be8c] text-neutral-800 dark:bg-[#a3be8c]/15 dark:text-[#a3be8c]',
    purple: 'bg-[#b48ead] text-white dark:bg-[#b48ead]/12 dark:text-[#b48ead]',
    amber: 'bg-[#ebcb8b] text-neutral-800 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]'
  }
...
const textClass = computed(() => {
  if (props.utilization >= 100) {
    ...
    return 'text-[#d08770]/80 dark:text-[#d08770]'
  } else {
