...
const concurrencyClass = computed(() => {
  ...
  if (current >= max) return 'bg-[#bf616a] text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]'
  if (current > 0) return 'bg-[#ebcb8b] text-neutral-900 dark:bg-[#ebcb8b]/12 dark:text-[#ebcb8b]'
  return 'bg-gray-100 text-gray-600 dark:bg-[#1e1e1e] dark:text-neutral-400'
})
...
const windowCostClass = computed(() => {
  ...
  if (current >= limit + reserve) return 'bg-[#bf616a] text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]'
  if (current >= limit) return 'bg-[#ebcb8b] text-neutral-800 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]'
  if (current >= limit * 0.8) return 'bg-[#ebcb8b] text-neutral-900 dark:bg-[#ebcb8b]/12 dark:text-[#ebcb8b]'
...
const sessionLimitClass = computed(() => {
  ...
  if (current >= max) return 'bg-[#bf616a] text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]'
  if (current >= max * 0.8) return 'bg-[#ebcb8b] text-neutral-900 dark:bg-[#ebcb8b]/12 dark:text-[#ebcb8b]'
  return 'bg-[#a3be8c] text-neutral-800 dark:bg-[#a3be8c]/15 dark:text-[#a3be8c]'
})
...
const rpmClass = computed(() => {
  ...
  if (rpmStrategy.value === 'tiered') {
    if (current >= base + buffer) return 'bg-[#bf616a] text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]'
    if (current >= base) return 'bg-[#ebcb8b] text-neutral-800 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]'
  } else {
    if (current >= base) return 'bg-[#ebcb8b] text-neutral-800 dark:bg-[#ebcb8b]/15 dark:text-[#ebcb8b]'
  }
  if (current >= base * 0.8) return 'bg-[#ebcb8b] text-neutral-900 dark:bg-[#ebcb8b]/12 dark:text-[#ebcb8b]'
  return 'bg-[#a3be8c] text-neutral-800 dark:bg-[#a3be8c]/15 dark:text-[#a3be8c]'
})
