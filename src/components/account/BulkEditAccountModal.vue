<template>
  ...
  >
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      <!-- Info -->
      <div class="rounded-lg bg-[#81a1c1]/12 p-4 dark:bg-[#81a1c1]/12">
        <p class="text-sm text-[#81a1c1]/80 dark:text-[#81a1c1]">
      ...
      <div v-if="isMixedPlatform" class="rounded-lg bg-[#ebcb8b]/12 p-4 dark:bg-[#ebcb8b]/15">
        <p class="text-sm text-[#d08770]/80 dark:text-[#d08770]">
          <svg class="mr-1.5 inline h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        <div class="mb-3 flex items-center justify-between">
          ...
          <input
            ...
            class="rounded border-gray-300 text-neutral-300 focus:ring-neutral-500"
          />
        </div>
        <div
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        ...
        >
          <div
            ...
            class="rounded-lg bg-[#ebcb8b]/12 p-3 dark:bg-[#ebcb8b]/15"
          >
          ...
          <template v-else>
            ...
            <div v-if="modelRestrictionMode === 'whitelist'">
              <div class="mb-3 rounded-lg bg-[#81a1c1]/12 p-3 dark:bg-[#81a1c1]/12">
      ...
      <div class="grid grid-cols-2 gap-4 border-t border-gray-200 pt-4 dark:border-neutral-800/60 lg:grid-cols-4">
        <div>
          <div class="mb-3 flex items-center justify-between">
            <label
      ...
      <div v-if="allOpenAIOAuth" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        <div class="mb-3 flex items-center justify-between">
          <label
      ...
      <div v-if="allOpenAIAPIKey" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        <div class="mb-3 flex items-center justify-between">
          <label
      ...
      <!-- OpenAI Compact mode -->
      <div v-if="allOpenAIPassthroughCapable" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex-1 pr-4">
            <label
      ...
      <div v-if="allAnthropicOAuthOrSetupToken" class="border-t border-gray-200 pt-4 dark:border-neutral-800/60">
        <div class="mb-3 flex items-center justify-between">
          <label
        ...
        >
          <div class="mb-3 flex items-center justify-between">
            <span class="text-sm text-neutral-600 dark:text-neutral-300">{{ t('admin.accounts.quotaControl.rpmLimit.hint') }}</span>
            <button
              type="button"
        ...
        <div class="mt-4">
          ...
          <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400 mb-2">
            ...
            <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
              ...
              :class="[
                ...
                userMsgQueueMode === opt.value
                  ...
                  : 'bg-white dark:bg-neutral-900 text-neutral-600 dark:text-neutral-300 border-gray-300 dark:border-neutral-700/60 hover:bg-gray-50 dark:hover:bg-dark-600'
              ]">
              {{ opt.label }}
            </button>
          </div>
