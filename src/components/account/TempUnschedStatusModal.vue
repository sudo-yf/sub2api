<template>
  ...
  >
    <div class="space-y-4">
      ...
      <div v-else-if="!isActive" class="rounded-lg border border-gray-200 p-4 text-sm text-neutral-500 dark:border-neutral-800/60 dark:text-neutral-400">
        {{ t('admin.accounts.tempUnschedulable.notActive') }}
      </div>

      <div v-else class="space-y-4">
        <div class="rounded-lg border border-[#88c0d0]/20 bg-[#a3be8c] p-3 text-sm text-neutral-800 dark:border-[#88c0d0]/25 dark:bg-[#0a1a0f]/10 dark:text-[#a3be8c]">
        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-neutral-800/60">
          ...
          <p class="mt-1 text-sm font-medium text-gray-900 dark:text-neutral-500">
            {{ account?.name || '-' }}
          </p>
        </div>

        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <div class="rounded-lg border border-gray-200 p-3 dark:border-neutral-800/60">
            <p class="text-xs text-neutral-500 dark:text-neutral-400">
        ...
        <div class="rounded-lg border border-gray-200 p-3 dark:border-neutral-800/60">
          ...
          <div class="mt-2 rounded bg-gray-50 p-2 text-xs text-gray-700 dark:bg-neutral-900 dark:text-neutral-300">
            {{ state?.error_message || '-' }}
          </div>
        </div>
      </div>
