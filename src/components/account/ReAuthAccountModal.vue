<template>
  ...
  >
    <div v-if="account" class="space-y-4">
      <!-- Account Info -->
      <div
        class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-neutral-800/60 dark:bg-neutral-900"
      >
        <div class="flex items-center gap-3">
          ...
          <div>
            <span class="block font-semibold text-neutral-100 dark:text-white">{{
              account.name
            }}</span>
      ...
      <div v-if="isGemini" class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-neutral-800/60 dark:bg-neutral-900">
        <div class="mb-2 text-sm font-medium text-neutral-600 dark:text-neutral-300">
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            <span class="block text-sm font-medium text-neutral-100 dark:text-white">
              {{
                geminiOAuthType === 'google_one'
                  ? 'Google One'
                  : geminiOAuthType === 'code_assist'
