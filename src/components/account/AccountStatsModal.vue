      ...
      <template v-else-if="stats">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-[#a3be8c]/12 p-1.5 dark:bg-[#a3be8c]/15">
                <svg
                  class="h-4 w-4 text-[#88c0d0]/80 dark:text-[#88c0d0]/80"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-lg bg-[#81a1c1]/12 p-1.5 dark:bg-[#81a1c1]/12">
                <Icon name="bolt" size="sm" class="text-[#81a1c1]/80 dark:text-[#81a1c1]" :stroke-width="2" />
              </div>
            </div>
            <p class="text-2xl font-bold text-neutral-100 dark:text-white">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#88c0d0]/12 p-1.5 dark:bg-[#88c0d0]/12">
                <svg
                  class="h-4 w-4 text-[#88c0d0]/80 dark:text-[#88c0d0]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#88c0d0]/12 p-1.5 dark:bg-[#88c0d0]/12">
                <Icon name="cube" size="sm" class="text-[#88c0d0]/80 dark:text-[#88c0d0]" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#b48ead]/8 p-1.5 dark:bg-[#b48ead]/12">
                <Icon name="bolt" size="sm" class="text-[#b48ead]/80 dark:text-[#b48ead]" :stroke-width="2" />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
