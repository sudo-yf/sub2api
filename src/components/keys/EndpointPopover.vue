...
<template>
  <div v-if="allEndpoints.length > 0" class="flex flex-wrap gap-2">
    <div
      ...
      :key="index"
      class="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs transition-colors hover:border-neutral-600/50 dark:border-neutral-800/60 dark:bg-neutral-800 dark:hover:border-neutral-600/50"
    >
      <span class="font-medium text-gray-600 dark:text-neutral-300">{{ item.name }}</span>
      <span
        v-if="item.isDefault"
        class="rounded bg-neutral-900/40 px-1 py-px text-[10px] font-medium leading-tight text-neutral-300 dark:bg-neutral-800/40 dark:text-neutral-400"
      ...
      <div class="group/endpoint relative flex items-center gap-1.5">
        ...
        >
          ...
          <p
            class="flex items-center gap-1.5 text-[11px] leading-4 text-neutral-300 dark:text-neutral-300"
            :class="item.description ? 'mt-1.5' : ''"
          >
            <span class="h-1.5 w-1.5 rounded-full bg-neutral-600 dark:bg-neutral-400"></span>
        ...
        <code
          class="cursor-pointer font-mono text-neutral-500 decoration-gray-400 decoration-dashed underline-offset-2 hover:text-neutral-200 hover:underline focus:text-neutral-300 focus:underline focus:outline-none dark:text-neutral-400 dark:decoration-gray-500 dark:hover:text-neutral-300 dark:focus:text-neutral-400"
          role="button"
          tabindex="0"
        ...
        <button
          ...
          :class="copiedEndpoint === item.endpoint
            ...
            : 'text-neutral-400 hover:text-neutral-500 dark:text-neutral-500 dark:hover:text-neutral-300'"
        ...
        <a
          ...
          class="rounded p-0.5 text-neutral-400 transition-colors hover:text-amber-400/80 dark:text-neutral-500 dark:hover:text-amber-400"
