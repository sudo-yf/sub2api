<template>
  <div class="card">
    <!-- Header -->
    <div class="border-b border-gray-100 px-4 py-3 dark:border-neutral-800/60">
      <div class="flex items-center justify-between">
        <div>
          <h2 class="text-base font-semibold text-neutral-100 dark:text-white">
    ...
    <div class="p-4">
      ...
      <div v-if="loading && !providers.length" class="flex items-center justify-center py-6">
        <div class="h-5 w-5 animate-spin rounded-full border-2 border-neutral-600/60 border-t-transparent" />
      </div>
      ...
      >
        <div v-for="p in localProviders" :key="p.id" class="flex items-start gap-2">
          <div class="drag-handle mt-3 flex cursor-grab items-center text-neutral-400 hover:text-neutral-500 active:cursor-grabbing dark:text-neutral-400 dark:hover:text-neutral-400">
