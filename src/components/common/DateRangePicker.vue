      ...
      <div v-if="isOpen" class="date-picker-dropdown">
        ...
        <div class="date-picker-custom">
          ...
          <div class="date-picker-separator">
            <Icon name="arrowRight" size="sm" class="text-neutral-400" />
          </div>
          <div class="date-picker-field">
...
.date-picker-trigger {
  ...
  @apply border border-gray-200 dark:border-neutral-800/60;
  @apply text-gray-700 dark:text-neutral-300;
  @apply transition-all duration-200;
  @apply focus:border-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-500/30;
  @apply hover:border-gray-300 dark:hover:border-neutral-600/60;
  @apply cursor-pointer;
}

.date-picker-trigger-open {
  @apply border-neutral-600/60 ring-2 ring-neutral-600/30;
}
...
.date-picker-preset {
  ...
  @apply hover:bg-gray-100 dark:hover:bg-neutral-900;
  @apply transition-colors duration-150;
}

.date-picker-preset-active {
  @apply bg-neutral-800 dark:bg-neutral-800/40;
  @apply text-neutral-200 dark:text-neutral-300;
}

.date-picker-divider {
  @apply border-t border-gray-100 dark:border-neutral-800/60;
}
...
.date-picker-label {
  @apply mb-1 block text-xs font-medium text-gray-500 dark:text-neutral-400;
}
