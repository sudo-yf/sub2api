          ...
          <div class="select-options" ref="optionsListRef">
            ...
            >
              <slot name="option" :option="option" :selected="isSelected(option)">
                ...
                />
                <span class="select-option-label" :class="option._creatable && 'italic text-neutral-500 dark:text-neutral-300'">{{ getOptionLabel(option) }}</span>
                <Icon
...
.select-dropdown-portal .select-option-group {
  ...
  @apply bg-dark-950 dark:bg-dark-950;
  @apply text-[11px] font-bold uppercase tracking-[0.12em];
  @apply text-neutral-400/70 dark:text-neutral-400/70;
  font-family: 'JetBrains Mono', ui-monospace, monospace;
}
