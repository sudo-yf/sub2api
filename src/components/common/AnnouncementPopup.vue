<template>
  <Teleport to="body">
    <Transition name="popup-fade">
      ...
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5 dark:bg-neutral-800 dark:ring-white/10"
          @click.stop
        >
          <!-- Header with warm gradient -->
          <div class="relative overflow-hidden border-b border-[#d08770]/20 bg-gradient-to-br from-amber-50/80 via-orange-50/50 to-yellow-50/30 px-8 py-6 dark:border-neutral-800/60 dark:from-amber-900/20 dark:via-orange-900/10 dark:to-yellow-900/5">
            ...
            <div class="relative z-10">
              ...
              <!-- Title -->
              <h2 class="mb-2 text-2xl font-bold leading-tight text-neutral-100 dark:text-white">
          ...
          <!-- Body -->
          <div class="max-h-[50vh] overflow-y-auto bg-white px-8 py-8 dark:bg-neutral-800">
            <div class="relative">
