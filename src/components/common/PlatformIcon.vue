<template>
  ...
  <svg v-if="platform === 'anthropic'" :class="iconClass" viewBox="0 0 16 16" fill="currentColor">
    <path
  ...
  <!-- OpenAI logo -->
  <svg v-else-if="platform === 'openai'" :class="iconClass" viewBox="0 0 24 24" fill="currentColor">
    <path
  ...
  <svg v-else-if="platform === 'gemini'" :class="iconClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2l1.89 7.2L21 12l-7.11 2.8L12 22l-1.89-7.2L3 12l7.11-2.8L12 2z" />
  </svg>
  <!-- Antigravity logo (cloud) -->
  <svg v-else-if="platform === 'antigravity'" :class="iconClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" />
  </svg>
  <!-- Fallback: generic platform icon -->
  <svg v-else :class="iconClass" fill="currentColor" viewBox="0 0 24 24">
    <path
...
const iconClass = computed(() => `${sizeClass.value} text-neutral-300/85`)
</script>
