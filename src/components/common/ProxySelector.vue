      ...
      <div v-if="isOpen" class="select-dropdown">
        ...
        <div class="select-header">
          <div class="select-search">
            <Icon name="search" size="sm" class="text-neutral-400" />
            <input
              ref="searchInputRef"
              v-model="searchQuery"
              type="text"
        ...
        <div class="select-options">
          ...
          >
            ...
            <Icon v-if="modelValue === null" name="check" size="sm" class="text-neutral-500" />
          </div>
          ...
          >
            <div class="min-w-0 flex-1">
              <div class="flex items-center gap-2">
                ...
                <span
                  ...
                  class="inline-flex flex-shrink-0 items-center rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-600 dark:bg-neutral-800 dark:text-neutral-400"
                >
                  {{ proxy.account_count }}
                </span>
                <!-- Test result badges -->
                <template v-if="testResults[proxy.id]">
                  <span
                    ...
                    class="inline-flex flex-shrink-0 items-center gap-1 rounded bg-[#a3be8c] px-1.5 py-0.5 text-xs text-[#a3be8c] dark:bg-[#a3be8c]/15 dark:text-[#a3be8c]"
                  >
                  ...
                  <span
                    v-else
                    class="inline-flex flex-shrink-0 items-center rounded bg-[#bf616a]/12 px-1.5 py-0.5 text-xs text-white dark:bg-[#bf616a]/12 dark:text-[#bf616a]"
                  >
            ...
            <Icon
              ...
              name="check"
              size="sm"
              class="flex-shrink-0 text-neutral-500"
            />
          </div>
...
.select-trigger {
  ...
  @apply bg-dark-950/95 dark:bg-dark-950/95;
  @apply border border-neutral-800/60 dark:border-neutral-800/60;
  @apply text-accent-50 dark:text-accent-50;
  @apply transition-all duration-200;
  @apply focus:border-neutral-600/60 focus:outline-none focus:ring-2 focus:ring-neutral-400/20;
  @apply hover:border-neutral-500/40 dark:hover:border-neutral-500/40;
  @apply cursor-pointer;
  font-family: 'JetBrains Mono', ui-monospace, monospace;
}

.select-trigger-open {
  @apply border-neutral-600/60 ring-2 ring-neutral-600/20;
}

.select-trigger-disabled {
  @apply cursor-not-allowed bg-[#0d0d0d] opacity-60 dark:bg-[#0d0d0d];
}
...
.select-icon {
  @apply flex-shrink-0 text-neutral-400/70 dark:text-neutral-400/70;
}

.select-dropdown {
  @apply absolute z-[100] mt-2 w-full;
  @apply bg-[#0d0d0d] dark:bg-[#0d0d0d];
  @apply rounded-xl;
  @apply border border-neutral-800/60 dark:border-neutral-800/60;
...
.select-header {
  ...
  @apply border-b border-neutral-800/60 dark:border-neutral-800/60;
}
...
.select-search-input {
  ...
  @apply text-accent-50 dark:text-accent-50;
  @apply placeholder:text-neutral-400/50 dark:placeholder:text-neutral-400/50;
...
.batch-test-btn {
  ...
  @apply text-neutral-400/70 hover:text-emerald-400 dark:hover:text-emerald-400;
  @apply hover:bg-emerald-900/20 dark:hover:bg-emerald-900/20;
...
.select-option {
  ...
  @apply hover:bg-neutral-800 dark:hover:bg-neutral-800;
}

.select-option-selected {
  @apply bg-neutral-800 dark:bg-neutral-800;
...
.select-empty {
  ...
  @apply text-neutral-400/80 dark:text-neutral-400/80;
}
