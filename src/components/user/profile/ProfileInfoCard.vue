<template>
  <div class="space-y-6">
    <section
      ...
      class="card overflow-hidden border border-neutral-800/60/80 bg-[#111111] dark:border-neutral-800/60 dark:from-neutral-900/40 dark:via-[#0d0d0d] dark:to-[#0a0a0a]"
    >
      <div class="px-6 py-6 md:px-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          <div
            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-[1.75rem] bg-gradient-to-br from-neutral-700 to-neutral-800 text-2xl font-bold text-white shadow-lg shadow-black/20"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                <h2 class="truncate text-2xl font-semibold text-neutral-100 dark:text-white">
                  {{ displayName }}
                </h2>
              ...
              <div class="space-y-1">
                ...
                >
                  <span
                    ...
                    :key="hint.key"
                    class="inline-flex items-center gap-1 rounded-full bg-white/80 px-3 py-1 ring-1 ring-neutral-700/40 dark:bg-[#0d0d0d]/70 dark:ring-neutral-700/40"
                  >
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="rounded-2xl bg-white/85 px-4 py-3 shadow-sm ring-1 ring-white/70 dark:bg-[#0d0d0d]/60 dark:ring-dark-700"
              >
                <p class="text-xs font-medium uppercase tracking-[0.16em] text-neutral-400 dark:text-neutral-500">
                  {{ t('profile.accountBalance') }}
                </p>
                <p class="mt-1 text-lg font-semibold text-neutral-100 dark:text-white">
    ...
    <div class="space-y-6">
      <div data-testid="profile-main-column" class="space-y-6">
        <section
          ...
          class="card border border-gray-100 bg-white/90 p-6 dark:border-neutral-800/60 dark:bg-[#0d0d0d]/50"
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div class="rounded-3xl border border-gray-100 bg-gray-50/80 p-5 dark:border-neutral-800/60 dark:bg-[#0d0d0d]/30">
              <ProfileAvatarCard
                :user="user"
                embedded
              />
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-2xl border border-gray-100 bg-gray-50/80 px-4 py-3 text-sm text-gray-600 dark:border-neutral-800/60 dark:bg-[#0d0d0d]/30 dark:text-neutral-300"
            >
              <Icon name="link" size="sm" class="mt-0.5 text-neutral-400 dark:text-neutral-500" />
              <span>{{ hint.text }}</span>
            </div>
          </div>
        </section>
