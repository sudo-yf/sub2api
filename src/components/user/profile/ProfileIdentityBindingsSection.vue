  ...
  <div :class="props.embedded ? 'space-y-4' : 'card overflow-hidden'">
    ...
    <div :class="props.embedded ? 'space-y-4' : 'divide-y divide-gray-100 dark:divide-dark-700'">
      <div v-if="props.embedded">
        <p class="text-sm font-semibold text-neutral-100 dark:text-white">
          {{ t('profile.authBindings.title') }}
        </p>
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
          {{ t('profile.authBindings.description') }}
          ...
          <div class="flex min-w-0 flex-1 items-start gap-4">
            ...
            <div class="min-w-0 flex-1 space-y-3">
              ...
              <div
                ...
                class="grid gap-1 text-sm text-neutral-500 dark:text-neutral-400"
              >
                <p
                  v-if="item.provider !== 'email' && item.details?.display_name"
                  class="font-medium text-gray-700 dark:text-neutral-500"
                >
...
const rowClass = computed(() =>
  props.embedded
    ? compact.value
      ? 'rounded-2xl border border-gray-100 bg-white p-4 shadow-sm dark:border-neutral-800/60 dark:bg-[#0d0d0d]/40'
      : 'rounded-2xl border border-gray-100 bg-gray-50/70 p-4 dark:border-neutral-800/60 dark:bg-[#0d0d0d]/30'
    : 'px-6 py-5'
)
...
function providerIconClass(provider: UserAuthProvider): string {
  ...
  return 'bg-neutral-800 text-neutral-300 dark:bg-neutral-800/30 dark:text-neutral-300'
}
