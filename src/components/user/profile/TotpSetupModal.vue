    ...
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md transform rounded-xl bg-white p-6 shadow-xl transition-all dark:bg-neutral-800">
        ...
        <div class="mb-6 text-center">
          <h3 class="text-xl font-semibold text-neutral-100 dark:text-white">
        ...
        <div v-if="step === 1" class="space-y-6">
          ...
          <template v-if="setupData">
            <div class="flex justify-center">
              <div class="rounded-lg border border-gray-200 p-4 bg-white dark:border-neutral-800/60 dark:bg-white">
            ...
            <div class="text-center">
              ...
              <div class="flex items-center justify-center gap-2">
                <code class="rounded bg-gray-100 px-3 py-2 font-mono text-sm dark:bg-neutral-900">
                  {{ setupData.secret }}
                </code>
                <button
                  type="button"
                  class="rounded p-1.5 text-neutral-500 hover:bg-gray-100 dark:hover:bg-neutral-900"
                  @click="copySecret"
                >
