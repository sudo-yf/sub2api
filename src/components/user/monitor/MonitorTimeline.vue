<template>
  <div class="mt-4 pt-3 border-t border-neutral-800/60">
    <div
      class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-neutral-400 mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-gray-300 dark:border-neutral-800/60 text-[10px] uppercase tracking-widest text-neutral-400"
    >
      {{ t('monitorCommon.maintenancePaused') }}
    </div>
    <div v-else class="flex items-end gap-px h-5 w-full overflow-hidden">
      <div
    ...
    <div
      class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-neutral-400"
    >
...
const STATUS_COLOR: Record<string, string> = {
  operational: 'bg-[#a3be8c]',
  degraded: 'bg-[#ebcb8b]',
  failed: 'bg-[#bf616a]',
  error: 'bg-[#bf616a]',
  empty: 'bg-gray-300 dark:bg-neutral-800',
}
