<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-xl border border-neutral-700/50 bg-gradient-to-r from-neutral-900/30 to-neutral-800/30 p-3 dark:border-neutral-700/40 dark:from-neutral-900/20 dark:to-neutral-800/20"
      >
        <div class="flex items-center gap-3">
          <div
            class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-neutral-700 to-neutral-800"
          >
            <Icon name="chartBar" size="md" class="text-white" />
          </div>
          <div>
            <div class="font-semibold text-gray-900 dark:text-neutral-500">{{ account.name }}</div>
        ...
        <span
          :class="[
            ...
            account.status === 'active'
              ...
              : 'bg-gray-100 text-gray-600 dark:bg-[#252525] dark:text-neutral-400'
          ]"
        >
          {{ account.status }}
        </span>
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-[#88c0d0]/20 bg-gradient-to-br from-emerald-50 to-white p-4 dark:border-[#88c0d0]/25 dark:from-emerald-900/10 dark:to-dark-700"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-neutral-500 dark:text-neutral-400">{{
                t('admin.accounts.stats.totalCost')
              }}</span>
              <div class="rounded-lg bg-[#a3be8c]/12 p-1.5 dark:bg-[#a3be8c]/15">
                <Icon name="dollar" size="sm" class="text-[#88c0d0]/80 dark:text-[#88c0d0]/80" />
              </div>
            </div>
            <p class="text-2xl font-bold text-neutral-100 dark:text-white">
          ...
          <div
            class="card border-[#81a1c1]/20 bg-gradient-to-br from-blue-50 to-white p-4 dark:border-[#81a1c1]/25 dark:from-blue-900/10 dark:to-dark-700"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-neutral-500 dark:text-neutral-400">{{
                t('admin.accounts.stats.totalRequests')
              }}</span>
              <div class="rounded-lg bg-[#81a1c1]/12 p-1.5 dark:bg-[#81a1c1]/12">
                <Icon name="bolt" size="sm" class="text-[#81a1c1]/80 dark:text-[#81a1c1]" />
              </div>
            </div>
            <p class="text-2xl font-bold text-neutral-100 dark:text-white">
          ...
          <!-- Daily Average Cost -->
          <div
            class="card border-[#d08770]/20 bg-gradient-to-br from-amber-50 to-white p-4 dark:border-[#d08770]/25 dark:from-amber-900/10 dark:to-dark-700"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-neutral-500 dark:text-neutral-400">{{
                t('admin.accounts.stats.avgDailyCost')
              }}</span>
              <div class="rounded-lg bg-[#ebcb8b]/12 p-1.5 dark:bg-[#ebcb8b]/15">
                <Icon
                  name="calculator"
                  size="sm"
                  class="text-[#d08770]/80 dark:text-[#d08770]"
                />
              </div>
            </div>
            <p class="text-2xl font-bold text-neutral-100 dark:text-white">
          ...
          <div
            class="card border-[#b48ead]/20 bg-gradient-to-br from-purple-50 to-white p-4 dark:border-[#b48ead]/25 dark:from-purple-900/10 dark:to-dark-700"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-neutral-500 dark:text-neutral-400">{{
                t('admin.accounts.stats.avgDailyRequests')
              }}</span>
              <div class="rounded-lg bg-[#b48ead]/12 p-1.5 dark:bg-[#b48ead]/12">
                <svg
                  class="h-4 w-4 text-[#b48ead]/80 dark:text-[#b48ead]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#88c0d0]/12 p-1.5 dark:bg-[#88c0d0]/12">
                <Icon name="clock" size="sm" class="text-[#88c0d0]/80 dark:text-[#88c0d0]" />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
                t('admin.accounts.stats.todayOverview')
              }}</span>
            </div>
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-neutral-500 dark:text-neutral-400">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-neutral-100 dark:text-white"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-neutral-500 dark:text-neutral-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-neutral-100 dark:text-white"
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#ebcb8b]/12 p-1.5 dark:bg-[#ebcb8b]/15">
                <Icon name="fire" size="sm" class="text-[#d08770]/80 dark:text-[#d08770]" />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-neutral-500 dark:text-neutral-400">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-[#d08770]/80 dark:text-[#d08770]"
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#5e81ac]/8 p-1.5 dark:bg-[#5e81ac]/12">
                <Icon
                  name="trendingUp"
                  size="sm"
                  class="text-[#5e81ac]/80 dark:text-[#5e81ac]"
                />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm font-semibold text-[#5e81ac]/80 dark:text-[#5e81ac]">{{
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#88c0d0]/12 p-1.5 dark:bg-[#88c0d0]/12">
                <Icon name="cube" size="sm" class="text-[#88c0d0]/80 dark:text-[#88c0d0]" />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#b48ead]/8 p-1.5 dark:bg-[#b48ead]/12">
                <Icon name="bolt" size="sm" class="text-[#b48ead]/80 dark:text-[#b48ead]" />
              </div>
              <span class="text-sm font-semibold text-neutral-100 dark:text-white">{{
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-lg bg-[#a3be8c]/12 p-1.5 dark:bg-[#a3be8c]/12">
                <Icon
                  name="clipboard"
                  size="sm"
      ...
      <div
        v-else-if="!loading"
        class="flex flex-col items-center justify-center py-12 text-neutral-500 dark:text-neutral-400"
      >
    ...
    <template #footer>
      <div class="flex justify-end">
        <button
          @click="handleClose"
          class="rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:bg-neutral-800 dark:text-neutral-300 dark:hover:bg-neutral-700"
        >
          {{ t('common.close') }}
        </button>
      </div>
