...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    case 'anthropic': return 'bg-[#d08770]/8 text-[#d08770]/80 dark:bg-[#d08770]/12 dark:text-[#d08770]'
    case 'openai': return 'bg-[#88c0d0]/8 text-[#88c0d0]/80 dark:bg-[#88c0d0]/12 dark:text-[#88c0d0]'
    case 'gemini': return 'bg-[#81a1c1]/8 text-[#81a1c1]/80 dark:bg-[#81a1c1]/12 dark:text-[#81a1c1]'
    case 'antigravity': return 'bg-[#b48ead]/8 text-[#b48ead]/80 dark:bg-[#b48ead]/12 dark:text-[#b48ead]'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'openai': return 'text-[#88c0d0]/80 dark:text-[#88c0d0]'
    case 'gemini': return 'text-[#81a1c1]/80 dark:text-[#81a1c1]'
