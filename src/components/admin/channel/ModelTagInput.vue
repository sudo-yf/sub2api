<template>
  <div>
    <!-- Tags display -->
    <div class="flex flex-wrap gap-1.5 rounded-lg border border-gray-200 bg-white p-2 dark:border-neutral-800/60 dark:bg-neutral-800 min-h-[2.5rem]">
      <span
      ...
      >
        ...
        <button
          ...
          class="ml-0.5 rounded-full p-0.5 hover:bg-neutral-700/50 dark:hover:bg-neutral-700"
        >
          <Icon name="x" size="xs" />
        </button>
      </span>
      <input
        ...
        v-model="inputValue"
        type="text"
        class="flex-1 min-w-[120px] border-none bg-transparent text-sm outline-none placeholder:text-neutral-400 dark:text-white"
