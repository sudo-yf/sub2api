<template>
  <div class="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-neutral-800/60 dark:bg-neutral-800/50">
    ...
    <div v-if="mode === 'custom'" class="mt-4 space-y-4">
      ...
      <div v-if="anyOf.length === 0" class="rounded-xl border border-dashed border-gray-300 p-4 text-sm text-neutral-500 dark:border-neutral-800/60 dark:text-neutral-400">
      ...
      <div
        ...
        :key="groupIndex"
        class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-neutral-800/60 dark:bg-neutral-800"
      >
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            <div class="text-sm font-medium text-neutral-100 dark:text-white">
              {{ t('admin.announcements.form.targetingCustom') }} #{{ groupIndex + 1 }}
              <span class="ml-2 text-xs font-normal text-neutral-500 dark:text-neutral-400">AND ({{ (group.all_of?.length || 0) }}/50)</span>
            </div>
            <div class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
        ...
        <div class="mt-4 space-y-3">
          <div
            ...
            :key="condIndex"
            class="rounded-xl border border-gray-200 bg-gray-50 p-3 dark:border-neutral-800/60 dark:bg-[#0d0d0d]/30"
          >
      ...
      <div v-if="validationError" class="rounded-xl border border-[#bf616a]/20 bg-[#bf616a] p-3 text-sm text-white dark:border-[#bf616a]/25 dark:bg-[#bf616a]/12 dark:text-[#bf616a]">
        {{ validationError }}
      </div>
    </div>
  </div>
