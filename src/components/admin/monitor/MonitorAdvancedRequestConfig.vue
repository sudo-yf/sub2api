  ...
  <div class="space-y-4">
    ...
    <div>
      ...
      <div class="space-y-1.5">
        ...
        >
          ...
          <button
            type="button"
            class="flex-none rounded p-1 text-neutral-400 hover:bg-[#bf616a] hover:text-red-400/70 dark:hover:bg-[#1a0a0a]/10 dark:hover:text-red-400"
        ...
        <button
          type="button"
          class="inline-flex items-center gap-1 rounded border border-dashed border-gray-300 px-2 py-1 text-xs text-neutral-500 hover:border-neutral-500 hover:text-neutral-200 dark:border-neutral-800/60 dark:text-neutral-400 dark:hover:border-neutral-500 dark:hover:text-neutral-300"
          @click="addRow"
        >
      ...
      <p v-if="headersError" class="mt-1 text-xs text-[#bf616a]/80">{{ headersError }}</p>
    ...
    <div v-if="bodyOverrideMode !== 'off'">
      <div class="mb-1 flex items-center justify-between">
        ...
        <button
          type="button"
          class="text-xs text-neutral-300 hover:underline disabled:cursor-not-allowed disabled:text-neutral-400 disabled:no-underline dark:text-neutral-400"
      ...
      <textarea
        ...
        @blur="commitBody"
      />
      <p v-if="bodyError" class="mt-1 text-xs text-[#bf616a]/80">{{ bodyError }}</p>
      <p v-else class="mt-1 text-xs text-neutral-400">
...
function bodyModeButtonClass(mode: BodyOverrideMode): string {
  ...
  if (active) {
    return 'border-neutral-600/60 bg-neutral-900/40 text-neutral-200 dark:bg-neutral-600/15 dark:text-neutral-300 dark:border-neutral-600/50'
  }
  return 'border-gray-200 bg-white text-gray-600 hover:border-neutral-600/50 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-400'
}
