      ...
      <div class="flex flex-1 flex-wrap items-end gap-4">
        ...
        <div ref="userSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          <button
            ...
            type="button"
            @click="clearUser"
            class="absolute right-2 top-9 text-neutral-400"
          ...
          <div
            ...
            class="absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-lg border bg-white shadow-lg dark:bg-[#1e1e1e]"
          >
            <button
              ...
              type="button"
              @click="selectUser(u)"
              class="w-full px-4 py-2 text-left hover:bg-gray-100 dark:hover:bg-[#252525]"
            >
              <span>{{ u.email }}</span>
              <span class="ml-2 text-xs text-neutral-400">#{{ u.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="apiKeySearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[240px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-neutral-400">#{{ k.id }}</span>
            </button>
          </div>
        </div>
        ...
        <div ref="accountSearchRef" class="usage-filter-dropdown relative w-full sm:w-auto sm:min-w-[220px]">
          ...
          >
            ...
            >
              ...
              <span class="ml-2 text-xs text-neutral-400">#{{ a.id }}</span>
            </button>
          </div>
        </div>
