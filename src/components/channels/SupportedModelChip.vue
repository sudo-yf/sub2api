  ...
  <div class="relative inline-block">
    <span
      ...
      :class="[
        ...
        effectivePlatform
          ...
          : 'border-gray-200 bg-gray-50 text-gray-700 dark:border-neutral-800/60 dark:bg-neutral-800 dark:text-neutral-300',
      ]"
      @mouseenter="onEnter"
      @mouseleave="onLeave"
      @focusin="onEnter"
    ...
    >
      ...
      <span
        ...
        class="rounded bg-gray-200/60 px-1 text-[10px] uppercase text-gray-600 dark:bg-neutral-900 dark:text-neutral-400"
      >
        {{ model.platform }}
      </span>
      {{ model.name }}
    ...
    <Teleport to="body">
      <div
        ...
        ref="popoverEl"
        role="tooltip"
        class="pointer-events-none fixed z-[99999] w-80 max-w-[min(22rem,calc(100vw-1rem))] rounded-lg border bg-white text-xs shadow-xl dark:bg-neutral-800"
      ...
      >
        ...
        >
          ...
          <span
            v-if="model.platform"
            class="flex-shrink-0 rounded bg-white/70 px-1.5 py-0.5 text-[10px] uppercase tracking-wide dark:bg-[#0d0d0d]/60"
          >
            {{ model.platform }}
          </span>
        </div>
        ...
        <div class="p-3">
          <div v-if="!model.pricing" class="text-neutral-400">
            {{ noPricingLabel }}
          </div>

          <div v-else class="space-y-2 text-neutral-300">
            <div class="flex justify-between">
              <span class="text-neutral-400">{{ t(prefixKey('billingMode')) }}</span>
...
const popoverHeaderClass = computed(() =>
  effectivePlatform.value
    ...
    : 'bg-gray-50 text-gray-700 dark:bg-neutral-900/60 dark:text-neutral-300',
)
