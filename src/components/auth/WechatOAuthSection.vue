<template>
  <div class="space-y-4">
    <button type="button" :disabled="buttonDisabled" class="btn btn-secondary w-full" @click="startLogin">
      <span
        class="mr-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-[#a3be8c]/12 text-xs font-semibold text-white dark:bg-[#a3be8c]/12 dark:text-[#a3be8c]"
      >
        W
      </span>
    ...
    <p
      ...
      class="text-sm text-[#d08770]/80 dark:text-[#d08770]"
    >
      {{ disabledHint }}
    </p>

    <div v-if="showDivider" class="flex items-center gap-3">
      <div class="h-px flex-1 bg-gray-200 dark:bg-neutral-900"></div>
